...
@property (readonly) const SCD_Struct_MT14* limits; 
...
-(SCD_Struct_MT15)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 ;
-(SCD_Struct_MT16)pipelineFlagsWithComputeVariant:(NSObject*)arg1 ;
...
-(void)getDefaultSamplePositions:(SCD_Struct_MT18*)arg1 count:(unsigned long long)arg2 ;
...
-(SCD_Struct_MT19)libraryCacheStats;
-(SCD_Struct_MT19)pipelineCacheStats;
-(id)newCommandQueueWithDescriptor:(id)arg1 ;
-(id)newArgumentEncoderWithLayout:(id)arg1 ;
-(id)newSharedEventWithMachPort:(unsigned)arg1 ;
-(const SCD_Struct_MT14*)limits;
