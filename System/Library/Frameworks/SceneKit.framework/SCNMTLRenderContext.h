...
@interface SCNMTLRenderContext : NSObject <SCNBufferStream> {
	...
	SCD_Struct_SC56 _renderPassParameters;
	NSMutableArray* _renderPasses;
	SCD_Struct_SC57 _currentStreamBufferIndices;
	...
	SCD_Struct_SC58* _processingContext;
	unsigned _seed;
	SCNSceneBuffer _frameUniforms[6];
	SCD_Struct_SC61 _sceneUniforms;
	SCD_Struct_SC62 _lightsData;
	SCD_Struct_SC64* _nodeUniforms;
	SCD_Struct_SC79* _lighting;
	Cache* _cache;
	SCD_Struct_SC81* _deferredRendering;
	SCD_Struct_SC82 _compositeRendering[2];
	SCNMTLRenderPipeline* _downSamplePipeline;
	SCD_Struct_SC83 _skCompositing;
	SCD_Struct_SC84 _debug;
	BOOL _showsAuthoringEnvironment;
	SCD_Struct_SC85 _compilationIssues;
	SCD_Struct_SC86 _renderTargets;
	SCD_Struct_SC87 _counters;
	SCD_Struct_SC88* _renderGraph;
...
-(id)newRenderTargetWithDescription:(SCD_Struct_SC46*)arg1 size:(unsigned long long)arg2 ;
...
-(id)_renderTargetWithDescription:(SCD_Struct_SC46)arg1 size:(id)arg2 name:(long long)arg3 ;
-(BOOL)_setupDescriptor:(id)arg1 forPass:(_C3DFXPass*)arg2 parameters:(SCD_Struct_SC56*)arg3 rendersIntoFinalDrawable:(BOOL*)arg4 ;
...
-(void)startProcessingRendererElementsWithEngineIterationContext:(SCD_Struct_SC90*)arg1 ;
...
-(void)drawWireframeOverlayForElements:(SCD_Struct_SC91*)arg1 range:(SCD_Struct_SC92)arg2 store:(C3DRendererElementStoreRef)arg3 passInstance:(_C3DFXPassInstance*)arg4 ;
...
-(BOOL)beginRenderPass:(_C3DFXPass*)arg1 parameters:(SCD_Struct_SC56)arg2 ;
-(void)endRenderPass;
-(void)setRenderPassParameters:(SCD_Struct_SC56)arg1 ;
-(void)_logLightingInformation;
-(void)_setSceneBufferAtVertexIndex:(long long)arg1 fragmentIndex:(long long)arg2 ;
-(void)processRendererElements:(SCD_Struct_SC91*)arg1 count:(unsigned)arg2 engineIterationContext:(SCD_Struct_SC90*)arg3 ;
