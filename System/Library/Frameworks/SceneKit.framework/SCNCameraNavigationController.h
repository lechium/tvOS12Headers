...
@interface SCNCameraNavigationController : NSObject <SCNEventHandler, SCNCameraControllerDelegate> {
	...
	BOOL _mouseDown;
	SCD_Union_SC126 _sceneBoundingSphere;
	 _translationOrigin;
	float _initialZoom;
	...
	SCD_Struct_SC127 _stickyAxis;
	SCD_Struct_SC128 _target;
	SCD_Struct_SC129 _inertia;
	SCD_Struct_SC137* _keyboard;
	SCD_Struct_SC128 _scrollWheelModifiers;
