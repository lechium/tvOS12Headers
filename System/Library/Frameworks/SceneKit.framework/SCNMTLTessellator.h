...
@interface SCNMTLTessellator : NSObject {
	...
	SCD_Struct_SC25 _cachedTessellator;
...
-(void)updateScreenSpaceAdaptiveTessellator:(SCD_Struct_SC27)arg1 parameters:(SCD_Struct_SC28*)arg2 ;
-(void)updateConstrainedEdgeLengthTessellator:(SCD_Struct_SC27)arg1 withMesh:(id)arg2 computeCommandEncoder:(id)arg3 ;
-(void)updateSubdivisionSurfaceTessellator:(SCD_Struct_SC27)arg1 parameters:(SCD_Struct_SC28*)arg2 ;
...
-(void)subdivisionSurfaceTessellationDraw:(SCD_Struct_SC29)arg1 ;
...
-(void)draw:(SCD_Struct_SC29)arg1 ;
-(void)dealloc;
-(void)update:(SCD_Struct_SC28*)arg1 ;
@end
