...
-(void)_computeDofUniforms:(SCD_Struct_SC139*)arg1 camera:(_C3DCamera*)arg2 cullingContext:(_C3DCullingContext*)arg3 passInstance:(_C3DFXPassInstance*)arg4 fxContext:(_C3DFXContext*)arg5 engineContext:(C3DEngineContextRef)arg6 ;
-(unsigned)_computeBloomBlurUniforms:(SCD_Struct_SC140*)arg1 textureSize:(float)arg2 radius:(BOOL)arg3 ;
