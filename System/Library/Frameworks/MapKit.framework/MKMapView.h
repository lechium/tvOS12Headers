...
@class MKMapViewInternal, UIView, MKAnnotationManager, MKAnnotationContainerView, MKAttributionLabel, UIImageView, NSTimer, MKDebugLocationConsole, _MKEnvironmentLabel, UILongPressGestureRecognizer, UITapGestureRecognizer, UIGestureRecognizer, MKMapGestureController, MKOverlayContainerView, MKBasicMapView, VKMapView, VKLabelMarker, MKScaleView, MKCompassView, MKUserLocation, VKRouteContext, VKNavContext, MKMapCamera, UITextView, UIPanGestureRecognizer, MKRotationFilter, UILayoutGuide, NSLayoutConstraint, NSObject, UIVisualEffectView, UISwipeGestureRecognizer, _MKMapInteractionControlsView, NSArray, _MKMapInteractionControlAction, _MKAnnotationSelectionEngine, _MKZoomSliderView, _MKRightSideOfTrackpadTouchGestureRecognizer, _MKGameControllerObserver, _MKCustomFeatureStore, MKMapViewLabelMarkerState, CLLocation, MKAnnotationView, NSString, NSDictionary, GEOResourceManifestConfiguration, GEOMapRegion, UIPinchGestureRecognizer, UIRotationGestureRecognizer, VKVenueFeatureMarker, VKVenueBuildingFeatureMarker;
