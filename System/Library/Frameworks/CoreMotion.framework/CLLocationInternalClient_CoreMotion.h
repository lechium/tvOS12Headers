...
-(unsigned char)getLocationForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(SCD_Struct_CL260*)arg5 ;
...
-(unsigned char)getGyroCalibrationDatabaseBiasFit:(SCD_Struct_CM27*)arg1 atTemperature:(float)arg2 ;
...
-(unsigned char)compassCalibrationDatabaseGetBias:(SCD_Struct_CL261*)arg1 magneticField:(SCD_Struct_CM1)arg2 acceleration:(SCD_Struct_CM1)arg3 ;
...
-(unsigned char)configure:(SCD_Struct_CL262)arg1 ;
@end
