...
@class UIView, UIVisualEffectView, NSLayoutConstraint, UIDynamicAnimator, UIDynamicItemBehavior, UIAttachmentBehavior, UIPushBehavior, _AVPlayerLayerThumbnailView, UIImageView, AVGradientView, UILabel, AVSpinnerView, _AVBlockedView, AVPlayer, AVPlayerItem, UIImage, _UIVisualEffectBackdropView, NSDate, NSString, NSArray, AVTransportBarMask, AVDurationTimeFormatter, NSDateFormatter, AVFrameSet;
