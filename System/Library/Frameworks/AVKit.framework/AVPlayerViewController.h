...
@class NSString, AVKeyValueObserverCollection, AVDelegateManager, AVAudioOnlyIndicatorView, UIView, AVPlayerLayerView, NSArray, AVNowPlayingPlaybackControlsViewController, AVInternalPlaybackOptions, AVContentProposalViewController, AVPlayer, NSTimer, AVPlayerController, AVGestureRecognizerDelegate, AVDigitizerTouchGestureRecognizer, UIPanGestureRecognizer, AVNonDigitizerTapRecognizer, AVPermissiveSwipeGestureRecognizer, UIDigitizerTapGestureRecognizer, UIDigitizerLongPressGestureRecognizer, UITapGestureRecognizer, AVTimeRangeCollection, NSURL, AVPlayerViewControllerTransition, UILayoutGuide, NSLayoutConstraint, NSObject, UIAlertController, NSDictionary, UIViewController, AVTransportBarViewController;
