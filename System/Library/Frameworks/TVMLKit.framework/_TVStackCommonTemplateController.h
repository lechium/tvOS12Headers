...
@property (nonatomic,retain) UIImage * bgBackdropImage;                                          //@synthesize bgBackdropImage=_bgBackdropImage - In the implementation block
...
-(UIImage *)bgBackdropImage;
-(void)setBgBackdropImage:(UIImage *)arg1 ;
