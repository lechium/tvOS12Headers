...
-(void)fetchAndStoreChangesWithOperationGroupName:(id)arg1 operationGroupNameSuffix:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)fetchAndStoreChangesWithForceFetch:(BOOL)arg1 operationGroupName:(id)arg2 operationGroupNameSuffix:(id)arg3 userInfo:(id)arg4 completion:(/*^block*/id)arg5 ;
...
-(void)fetchAndStoreChangesWithForceFetch:(BOOL)arg1 operationGroupName:(id)arg2 operationGroupNameSuffix:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)_fetchRecordsWithQuery:(id)arg1 operationGroupName:(id)arg2 zone:(id)arg3 completion:(/*^block*/id)arg4 ;
-(id)cloudRecordObjectFromItemType:(unsigned long long)arg1 records:(id)arg2 ;
-(void)processFetchedCloudStoreDataWithModifiedRecords:(id)arg1 deletedRecords:(id)arg2 operationGroupName:(id)arg3 operationGroupNameSuffix:(id)arg4 shouldUpdateLocalDatabase:(BOOL)arg5 completion:(/*^block*/id)arg6 ;
