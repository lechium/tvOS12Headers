...
@interface CompositionTrackGroup : NSObject {
	...
	SCD_Struct_TV2 m_cursor;
	SCD_Struct_TV2 m_cursorForMovieAudio;
	BOOL m_videoTrackInUse;
	BOOL m_shouldAddVolumePointsAsWorkaround;
	SCD_Struct_TV2 m_cursorAtLastVideoInsertion;
	SCD_Struct_TV2 m_timeOfLastVolumeChange;
	float m_volumeAtLastVolumeChange;
	float m_volumeChangePending;
	SCD_Struct_TV2 m_timeOfLastRequest;
	BOOL _isExporting;
	BOOL _seenSpeedClip;
	...
	SCD_Struct_TV2 m_fadeOutStart;
	SCD_Struct_TV2 m_fadeOutDuration;
	SCD_Struct_TV2 _lastRampToZeroEnd;
...
@property (assign,nonatomic) SCD_Struct_TV2 lastRampToZeroEnd;                                 //@synthesize lastRampToZeroEnd=_lastRampToZeroEnd - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_TV2 cursor; 
@property (nonatomic,readonly) SCD_Struct_TV2 cursorAtLastVideoInsertion; 
@property (assign,nonatomic) SCD_Struct_TV2 timeOfLastVolumeChange; 
@property (assign,nonatomic) SCD_Struct_TV2 timeOfLastRequest; 
@property (assign,nonatomic) float volumeAtLastVolumeChange; 
@property (assign,nonatomic) float volumeChangePending; 
@property (assign,nonatomic) SCD_Struct_TV2 fadeOutStart; 
@property (assign,nonatomic) SCD_Struct_TV2 fadeOutDuration; 
...
-(void)applyCompositionItem:(id)arg1 atTime:(SCD_Struct_TV2)arg2 ;
-(void)applyPaddingToTime:(SCD_Struct_TV2)arg1 ;
-(SCD_Struct_TV2)lastRampToZeroEnd;
-(void)applyCompositionItem:(id)arg1 atTime:(SCD_Struct_TV2)arg2 videoOnly:(BOOL)arg3 ;
...
-(BOOL)requestVolume:(float)arg1 atTime:(SCD_Struct_TV2)arg2 ;
-(void)applyAudioMixParameters:(id)arg1 ;
-(void)applyFlexAudioMix:(id)arg1 ;
-(void)setTimeOfLastVolumeChange:(SCD_Struct_TV2)arg1 ;
-(void)setVolumeAtLastVolumeChange:(float)arg1 ;
-(void)setVolumeChangePending:(float)arg1 ;
-(void)setTimeOfLastRequest:(SCD_Struct_TV2)arg1 ;
-(void)setLastRampToZeroEnd:(SCD_Struct_TV2)arg1 ;
-(float)volumeChangePending;
-(SCD_Struct_TV2)timeOfLastRequest;
-(float)volumeAtLastVolumeChange;
-(SCD_Struct_TV2)timeOfLastVolumeChange;
-(BOOL)commitPendingVolumeToTime:(SCD_Struct_TV2)arg1 ;
-(SCD_Struct_TV2)fadeOutStart;
-(float)linearFadeOutValueForTime:(SCD_Struct_TV2)arg1 ;
...
-(SCD_Struct_TV2)cursorAtLastVideoInsertion;
-(void)setFadeOutStart:(SCD_Struct_TV2)arg1 ;
...
-(void)setFadeOutDuration:(SCD_Struct_TV2)arg1 ;
-(SCD_Struct_TV2)fadeOutDuration;
-(SCD_Struct_TV2)cursor;
-(BOOL)validate;
@end
