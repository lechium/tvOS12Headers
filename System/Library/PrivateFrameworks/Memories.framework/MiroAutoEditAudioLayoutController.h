...
@interface MiroAutoEditAudioLayoutController : NSObject {
	...
	SCD_Struct_TV2 _lastBeatTime;

}

@property (assign,nonatomic) SCD_Struct_TV2 lastBeatTime;              //@synthesize lastBeatTime=_lastBeatTime - In the implementation block
...
-(void)setLastBeatTime:(SCD_Struct_TV2)arg1 ;
-(void)applyJAndLCuts;
...
-(SCD_Struct_TV2)lastBeatTime;
-(id)_onsetDrivenInterestingBeatsForTime:(SCD_Struct_TV2)arg1 metadataDict:(id)arg2 ;
-(id)_segmentAndBeatsBasedInterestingBeatsForTime:(SCD_Struct_TV2)arg1 metadataDict:(id)arg2 ;
...
-(id)_timedMetadataItemAtTime:(SCD_Struct_TV2)arg1 forFlexAudioClip:(id)arg2 withIdentifier:(id)arg3 ;
