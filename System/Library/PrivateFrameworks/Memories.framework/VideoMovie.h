...
@interface VideoMovie : Movie <NSCoding, NSCopying> {
	...
	SCD_Struct_TV2 _cachedPreciseAssetDuration;
...
@property (assign,nonatomic) SCD_Struct_TV2 cachedPreciseAssetDuration;                //@synthesize cachedPreciseAssetDuration=_cachedPreciseAssetDuration - In the implementation block
...
-(void)setCachedPreciseAssetDuration:(SCD_Struct_TV2)arg1 ;
...
-(SCD_Struct_TV2)cachedPreciseAssetDuration;
