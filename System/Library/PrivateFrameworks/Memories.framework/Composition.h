...
@property (nonatomic,readonly) SCD_Struct_TV2 duration; 
...
-(void)setProject:(id)arg1 frameDuration:(SCD_Struct_TV2)arg2 viewSize:(CGSize)arg3 forFullScreen:(BOOL)arg4 ;
...
-(SCD_Struct_TV2)extensionForTransitionsSupportingEatLeftRight:(id)arg1 leftSideOfTransition:(BOOL)arg2 splitClip:(BOOL*)arg3 ;
-(SCD_Struct_TV2)transitionExtensionForClip:(id)arg1 left:(BOOL)arg2 splitClip:(BOOL*)arg3 ;
...
-(SCD_Struct_Mi11)sourceTimeRangeForClip:(id)arg1 endOfComposition:(SCD_Struct_TV2)arg2 projectStartTime:(SCD_Struct_TV2*)arg3 ;
-(BOOL)addVolumeRampToTrackGroup:(id)arg1 forClip:(id)arg2 shouldUseDucking:(BOOL)arg3 ;
-(SCD_Struct_Mi11)sourceTimeRangeForAudioClip:(id)arg1 endOfComposition:(SCD_Struct_TV2)arg2 ;
...
-(BOOL)writeVolumeRampToCompositionFromTrackGroup:(id)arg1 endOfComposition:(SCD_Struct_TV2)arg2 ;
-(float)percentBetweenRange:(SCD_Struct_Mi11)arg1 forTime:(SCD_Struct_TV2)arg2 firstRange:(SCD_Struct_Mi11*)arg3 secondRange:(SCD_Struct_Mi11*)arg4 ;
-(id)splitCompositionInstruction:(id)arg1 atTime:(SCD_Struct_TV2)arg2 options:(int)arg3 ;
...
-(id)splitCompositionState:(id)arg1 forCutaways:(id)arg2 searchIndex:(int*)arg3 projectDuration:(SCD_Struct_TV2)arg4 ;
-(void)updateVideoAndAudioInstructionForState:(id)arg1 cutSwaped:(BOOL)arg2 originalState:(id)arg3 ;
-(void)updateCutawayCompositionTracks:(SCD_Struct_TV2)arg1 ;
-(void)updateInstructionsWithTitles:(id)arg1 ;
-(void)updateBackgroundAudioCompositionTracks:(SCD_Struct_TV2)arg1 ;
-(void)updateForegroundAudioCompositionTracks:(SCD_Struct_TV2)arg1 ;
-(BOOL)insertASilentAudioTrackAsWorkaround;
-(SCD_Struct_TV2)fadeToBlackStartCMTime;
-(SCD_Struct_TV2)fadeToBlackDurationCMTime;
-(id)splitCompositionState:(id)arg1 atTime:(SCD_Struct_TV2)arg2 ;
...
-(void)splitCompositionInstructionListAtTime:(SCD_Struct_TV2)arg1 options:(int)arg2 ;
