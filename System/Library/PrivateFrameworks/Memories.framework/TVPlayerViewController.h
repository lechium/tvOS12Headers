...
@interface TVPlayerViewController : MiroPlayerViewController <UIGestureRecognizerDelegate, MoodDelegate, DurationDelegate> {
	...
	SCD_Struct_TV2 _teardownTimeofPlayer;
...
@property (assign) SCD_Struct_TV2 teardownTimeofPlayer;                                    //@synthesize teardownTimeofPlayer=_teardownTimeofPlayer - In the implementation block
...
-(void)setTeardownTimeofPlayer:(SCD_Struct_TV2)arg1 ;
-(void)signalCustomCompositorScheduler:(SCD_Struct_TV2)arg1 playerRate:(float)arg2 ;
...
-(void)setCurrentTime:(SCD_Struct_TV2)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(SCD_Struct_TV2)teardownTimeofPlayer;
-(void)dealloc;
