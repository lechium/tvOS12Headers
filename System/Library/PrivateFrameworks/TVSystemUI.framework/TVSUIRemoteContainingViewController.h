...
@interface TVSUIRemoteContainingViewController : UIViewController <TVSUIViewServiceRemoteInterface> {
	...
	SCD_Struct_TV4 _controllerRespondsTo;
	BOOL _didPresentClient;
...
@property (assign,nonatomic) BOOL didPresentClient;                                                      //@synthesize didPresentClient=_didPresentClient - In the implementation block
...
-(BOOL)didPresentClient;
-(void)setDidPresentClient:(BOOL)arg1 ;
...
-(void)_noteWillAppear:(BOOL)arg1 ;
-(void)_noteWillDisappear:(BOOL)arg1 ;
-(void)_noteDidAppear:(BOOL)arg1 ;
-(void)_noteDidDisappear:(BOOL)arg1 ;
