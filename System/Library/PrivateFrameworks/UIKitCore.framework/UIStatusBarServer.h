...
+(id)_cachedTimeStringFromData:(SCD_Struct_UI87*)arg1 ;
+(void)runServer;
+(void)postStatusBarData:(const SCD_Struct_UI87*)arg1 withActions:(int)arg2 ;
+(void)postStatusBarOverrideData:(SCD_Struct_UI90*)arg1 ;
+(void)permanentizeStatusBarOverrideData;
+(const SCD_Struct_UI87*)getStatusBarData;
+(SCD_Struct_UI90*)getStatusBarOverrideData;
...
-(void)_receivedStatusBarData:(SCD_Struct_UI87*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
