...
+(id)valueWithDecomposedTransform:(SCD_Struct_UI116)arg1 rotationEpsilon:(double)arg2 scaleEpsilon:(double)arg3 translationEpsilon:(double)arg4 ;
+(id)valueWithDecomposedTransform:(SCD_Struct_UI116)arg1 ;
-(NSString *)debugDescription;
-(id)copyWithZone:(NSZone*)arg1 ;
-(id)getValue;
-(id)interpolateTo:(id)arg1 progress:(double)arg2 ;
-(id)multiplyByVector:(id)arg1 ;
-(void)integrateWithVelocity:(id)arg1 target:(id)arg2 intermediateTarget:(id)arg3 intermediateTargetVelocity:(id)arg4 parameters:(SCD_Struct_UI115)arg5 state:(SCD_Struct_UI106)arg6 delta:(double)arg7 ;
-(BOOL)isUndefined;
