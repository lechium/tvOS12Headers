...
+(id)factoryForVisualStyle:(SCD_Struct_UI58)arg1 renderingContext:(id)arg2 ;
...
+(Class)factoryClassForVisualStyle:(SCD_Struct_UI58)arg1 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI58)arg1 renderingContext:(id)arg2 skipLayoutSegments:(BOOL)arg3 ;
+(id)_characterSetForGlyphSelectors;
+(id)lightweightFactoryForVisualStyle:(SCD_Struct_UI58)arg1 renderingContext:(id)arg2 ;
-(void)dealloc;
-(double)scale;
