...
@interface UIStatusBarServerListener : NSObject {
	...
	SCD_Struct_UI87 _statusBarData;
	SCD_Struct_UI87 _composedStatusBarData;
	SCD_Struct_UI88 _overrides;
...
-(SCD_Struct_UI90*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI87*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI90*)arg1 ;
