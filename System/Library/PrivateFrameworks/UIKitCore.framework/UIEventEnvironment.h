...
@class UIApplication, NSMutableArray, UITouchesEvent, UIPressesEvent, UIWheelEvent, _UIGameControllerEvent, UIPhysicalKeyboardEvent, UITouch, NSMutableDictionary, NSMutableSet, NSSet;
