...
@interface UISwipeOccurrence : NSObject <UISwipeActionPullViewDelegate> {
	...
	SCD_Struct_UI94 _currentSwipeInfo;
...
@property (assign,nonatomic) SCD_Struct_UI94 currentSwipeInfo;                         //@synthesize currentSwipeInfo=_currentSwipeInfo - In the implementation block
...
-(void)updateLayout;
-(void)beginSwipe;
-(void)moveItemWithSwipeInfo:(SCD_Struct_UI94)arg1 completion:(/*^block*/id)arg2 ;
-(void)resetItemWithSwipeInfo:(SCD_Struct_UI94)arg1 animated:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
-(id)initWithController:(id)arg1 indexPath:(id)arg2 ;
-(SCD_Struct_UI93)prepareWithSwipeDirection:(unsigned long long)arg1 configuration:(id)arg2 ;
-(BOOL)shouldDismissWithTouchLocation:(CGPoint)arg1 ;
-(void)performPrimaryActionWithSwipeInfo:(SCD_Struct_UI94)arg1 ;
...
-(void)_resetItemWithSwipeInfo:(SCD_Struct_UI94)arg1 animated:(BOOL)arg2 deletion:(BOOL)arg3 completion:(/*^block*/id)arg4 ;
-(void)endSwipe;
-(BOOL)shouldReenableUserInteraction;
-(void)_updateLayoutUsingCurrentSwipeInfo:(BOOL)arg1 ;
-(void)_performSwipeAction:(id)arg1 inPullview:(id)arg2 swipeInfo:(SCD_Struct_UI94)arg3 ;
...
-(SCD_Struct_UI94)currentSwipeInfo;
-(void)setCurrentSwipeInfo:(SCD_Struct_UI94)arg1 ;
-(UIView *)swipedView;
