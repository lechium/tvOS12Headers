...
@interface UIStatusBar_Base : _UIScrollsToTopInitiatorView <UIStatusBarServerClient> {
	...
	SCD_Struct_UI90* _localDataOverrides;
...
@property (nonatomic,readonly) SCD_Struct_UI90* localDataOverrides;                                                 //@synthesize localDataOverrides=_localDataOverrides - In the implementation block
...
-(int)styleOverrides;
-(void)statusBarServer:(id)arg1 didReceiveStatusBarData:(const SCD_Struct_UI87*)arg2 withActions:(int)arg3 ;
...
-(void)forceUpdateToData:(const SCD_Struct_UI87*)arg1 animated:(BOOL)arg2 ;
...
-(SCD_Struct_UI90*)localDataOverrides;
...
-(void)setLocalDataOverrides:(SCD_Struct_UI90*)arg1 ;
