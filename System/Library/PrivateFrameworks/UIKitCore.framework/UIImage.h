...
@class NSMapTable, UITraitCollection, _UIImageVectorImageSupport, UIImageAsset, NSURL, NSString, CIImage, NSArray, UIGraphicsImageRendererFormat;
...
-(SCD_Struct_UI48)bl_pixelAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(float)bl_lumaAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(SCD_Struct_UI48)bl_pixelAtX:(int)arg1 y:(int)arg2 ;
...
-(SCD_Struct_UI51)_calculateStatistics;
-(id)_imagePaddedByInsets:(UIEdgeInsets)arg1 ;
-(void)compositeToPoint:(CGPoint)arg1 operation:(int)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI53)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI53)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)compositeToPoint:(CGPoint)arg1 fromRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI52)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI52)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI53)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI52)arg1 inRect:(CGRect)arg2 ;
