...
@class UIView, UIScrollView, NSArray, UILongPressGestureRecognizer, UIGestureRecognizer, NSMutableSet, _UIInterfaceActionSelectByPressGestureRecognizer, NSPointerArray, NSString;
