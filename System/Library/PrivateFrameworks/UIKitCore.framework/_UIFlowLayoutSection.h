...
@interface _UIFlowLayoutSection : NSObject {
	...
	SCD_Struct_UI22 _rowAlignmentOptions;
	CGSize _itemSize;
...
@property (assign,nonatomic) SCD_Struct_UI22 rowAlignmentOptions;                                 //@synthesize rowAlignmentOptions=_rowAlignmentOptions - In the implementation block
...
-(SCD_Struct_UI22)rowAlignmentOptions;
...
-(void)setRowAlignmentOptions:(SCD_Struct_UI22)arg1 ;
