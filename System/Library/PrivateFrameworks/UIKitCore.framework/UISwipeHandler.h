...
@class UISwipeDismissalGestureRecognizer, _UISwipeActionPanGestureRecognizer, UISwipeActionController, NSString;
...
@interface UISwipeHandler : NSObject <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI93 _currentSwipeConfig;
...
@property (nonatomic,readonly) SCD_Struct_UI93 currentSwipeConfig; 
...
-(SCD_Struct_UI93)currentSwipeConfig;
-(void)resetSwipe;
-(BOOL)isInteracting;
...
-(SCD_Struct_UI91)_currentSwipeInfoWithTargetOffset:(double)arg1 animated:(BOOL)arg2 usingSpringWithStiffness:(double)arg3 ;
