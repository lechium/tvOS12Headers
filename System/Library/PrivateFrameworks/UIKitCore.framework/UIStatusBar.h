...
@interface UIStatusBar : UIStatusBar_Base <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI87 _currentRawData;
...
+(void)getData:(SCD_Struct_UI87*)arg1 forRequestedData:(const SCD_Struct_UI87*)arg2 withOverrides:(const SCD_Struct_UI90*)arg3 ;
...
-(void)statusBarStateProvider:(id)arg1 didPostStatusBarData:(const SCD_Struct_UI87*)arg2 withActions:(int)arg3 ;
