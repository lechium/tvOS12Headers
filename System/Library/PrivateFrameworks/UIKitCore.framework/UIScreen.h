...
@class NSDictionary, NSArray, _UIScreenFixedCoordinateSpace, UITraitCollection, _UIDisplayEdgeInfoProvider, FBSDisplayConfiguration, UISoftwareDimmingWindow, _UIFocusScrollManager, _UIFocusMovementPerformer, _UIScreenFocusSystemManager, UIFocusSystem, _UIScreenBoundingPathUtilities, UIWindow, NSString, UIScreenMode, UIView;

@interface UIScreen : NSObject <_CRKImageLoaderDelegate, UICoordinateSpace, _UITraitEnvironmentInternal, _UIFocusEnvironmentInternal, _UIFocusRegionContainer, UIFocusItemContainer, _UIFocusEnvironmentPrivate, UITraitEnvironment> {
	...
	SCD_Struct_UI54 _carPlayHumanPresenceStatus;
