...
@class UIScrollView, UIView, UITableViewRowData, _UITableViewSubviewManager, NSMutableArray, NSMutableDictionary, NSIndexPath, _UITableViewDeleteAnimationSupport, _UITableViewReorderingSupport, UITableViewWrapperView, UITableViewIndex, UITableViewCountView, NSArray, UITableViewIndexOverlayIndicatorView, NSTimer, UITableViewIndexOverlaySelectionView, UIColor, UIVisualEffect, UISwipeGestureRecognizer, UIGobblerGestureRecognizer, UITableViewCell, UILongPressGestureRecognizer, UITapGestureRecognizer, UITouch, NSMutableSet, _UITableViewUpdateSupport, _UITableViewShadowUpdatesController, UIWindow, UIFocusContainerGuide, _UITableViewPrefetchContext, NSString;
