...
@property (assign,nonatomic) unsigned long long _countOfMotionEffectsInSubtree; 
...
-(void)ax_setContentHuggingAndCompressionResistance:(SCD_Struct_UI75)arg1 ;
