...
@class UIKeyboardTaskQueue, _UIKeyboardTextSelectionController, TIKeyboardState, TIKeyboardInputManagerState, UIView, NSString, UIKeyboardAutocorrectionController, UIAutocorrectInlinePrompt, TIKeyboardCandidateResultSet, UIKeyboardLayout, NSMutableDictionary, UIKeyboardScheduledTask, UIDelayedAction, UITextInputTraits, UILexicon, NSMutableArray, UITextInputArrowKeyHistory, UIKBAutofillController, NSDictionary, _UIKeyboardImplProxy, TISmartPunctuationController, TIKeyboardTouchEvent, _UIActionWhenIdle, UIPhysicalKeyboardEvent, UIAlertView, RTIInputSystemClient, RTIDocumentTraits, RTIDocumentState, TICandidateRequestToken, UITextSelectionView, TIKeyboardInputManagerStub, UIResponder, TIKeyboardLayout;
