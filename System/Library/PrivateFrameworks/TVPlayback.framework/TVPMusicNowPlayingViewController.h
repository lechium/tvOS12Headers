...
@class NSOperationQueue, TVPMusicBarsView, NSIndexPath, UITapGestureRecognizer, UIDigitizerTapGestureRecognizer, UIDigitizerLongPressGestureRecognizer, TVPB39TapGestureRecognizer, UILongPressGestureRecognizer, TVPB239FingerRestGestureRecognizer, _TVPRoutePickerButton, NSString, MPAVRoute, NSObject, _TVPMusicNowPlayingInvalidationContext, NSTimer, TVSStateMachine, TVPAudioTransportBarView, TVPPlaybackProgressAnimator, TVPDefiniteDurationPlaybackProgress, NSDate, NSArray, TVSUIRestrictionsPasscodeEntryViewController, UIScrollView, TVPScrubbingConfiguration, TVPChapter, TVPMusicVideoPlayerViewController, TVPHardwareButtonEventManager, _TVPMusicNowPlayingSelectedItemCoordinator, TVPMusicNowPlayingView;
