...
@interface GEOVectorTile : NSObject {
	...
	SCD_Struct_GE139* _linesLabelAnnotations;
	unsigned long long _linesLabelAnnotationCount;
	SCD_Struct_GE140* _linesAnnotationBezierVertices;
	SCD_Struct_GE69* _coastlines;
	unsigned long long _coastlinesCount;
	SCD_Struct_GE141* _polygons;
	...
	SCD_Struct_GE140* _transitStationTransferVertices;
	SCD_Struct_GE163* _transitStationTransfers;
	unsigned long long _transitStationTransferCount;
	SCD_Struct_GE135* _transitJunctions;
	unsigned long long _transitJunctionCount;
	SCD_Struct_GE150* _transitPointsOnRoad;
...
@property (nonatomic,readonly) SCD_Struct_GE146* threeDBuildings; 
@property (nonatomic,readonly) SCD_Struct_GE146* overlapThreeDBuildings; 
...
@property (nonatomic,readonly) SCD_Struct_GE139* linesLabelAnnotations;                               //@synthesize linesLabelAnnotations=_linesLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* linesAnnotationBezierVertices;                       //@synthesize linesAnnotationBezierVertices=_linesAnnotationBezierVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE141* polygons;                                            //@synthesize polygons=_polygons - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE142* venues;                                              //@synthesize venues=_venues - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE143* venueBuildings;                                      //@synthesize venueBuildings=_venueBuildings - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* venueVertices;                                       //@synthesize venuesVertices=_venuesVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE144* venueLevels;                                         //@synthesize venueLevels=_venueLevels - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE145* venueComponents;                                     //@synthesize venueComponents=_venueComponents - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE148* labelTextPlacements;                                 //@synthesize labelTextPlacements=_labelTextPlacements - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE149* overpasses;                                          //@synthesize overpasses=_overpasses - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE135* junctions;                                           //@synthesize junctions=_junctions - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE150* pointsOnRoad;                                        //@synthesize pointsOnRoad=_pointsOnRoad - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE150* laneConnections;                                     //@synthesize laneConnections=_laneConnections - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE158* lineCharacteristicPoints;                            //@synthesize lineCharacteristicPoints=_lineCharacteristicPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE158* polygonCharacteristicPoints;                         //@synthesize polygonCharacteristicPoints=_polygonCharacteristicPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE158* coastlineCharacteristicPoints;                       //@synthesize coastlineCharacteristicPoints=_coastlineCharacteristicPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE150* lineStrokeSpecifications;                            //@synthesize lineStrokeSpecifications=_lineStrokeSpecifications - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE150* polygonStrokeSpecifications;                         //@synthesize polygonStrokeSpecifications=_polygonStrokeSpecifications - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE152* curveLineVertices; 
@property (nonatomic,readonly) SCD_Struct_GE140* lineVertices; 
...
@property (nonatomic,readonly) SCD_Struct_GE159* transitLines;                                        //@synthesize transitLines=_transitLines - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE160* transitSystems;                                      //@synthesize transitSystems=_transitSystems - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE161* transitLinks;                                        //@synthesize transitLinks=_transitLinks - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* transitVertices;                                     //@synthesize transitVertices=_transitVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* transitStationTransferVertices;                      //@synthesize transitStationTransferVertices=_transitStationTransferVertices - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE163* transitStationTransfers;                             //@synthesize transitStationTransfers=_transitStationTransfers - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE135* transitJunctions;                                    //@synthesize transitJunctions=_transitJunctions - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE150* transitPointsOnRoad;                                 //@synthesize transitPointsOnRoad=_transitPointsOnRoad - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE164* transitAccessPoints;                                 //@synthesize transitAccessPoints=_transitAccessPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE139* transitLinkLabelAnnotations;                         //@synthesize transitLinkLabelAnnotations=_transitLinkLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* transitLinkAnnotationBezierVertices;                 //@synthesize transitLinkAnnotationBezierVertices=_transitLinkAnnotationBezierVertices - In the implementation block
...
-(SCD_Struct_GE161*)transitLinks;
-(GEOTileKey)tileKey;
-(unsigned long long)transitNodeCount;
-(GEOTransitNodeFeature*)transitNodes;
-(unsigned long long)transitAccessPointCount;
-(SCD_Struct_GE164*)transitAccessPoints;
-(SCD_Struct_GE69*)lines;
-(void)forEachEdgeOnJunction:(const SCD_Struct_GE135*)arg1 visitor:(/*^block*/id)arg2 ;
...
-(SCD_Struct_GE140*)transitVertices;
-(unsigned long long)linesCount;
-(void)forEachPoint:(/*^block*/id)arg1 ;
-(void)forEachPolygon:(/*^block*/id)arg1 ;
-(void)forEachTransitLinkOnJunction:(const SCD_Struct_GE135*)arg1 visitor:(/*^block*/id)arg2 ;
-(SCD_Struct_GE150*)transitPointsOnRoad;
...
-(SCD_Struct_GE141*)polygons;
-(unsigned long long)polygonsCount;
-(SCD_Struct_GE159*)transitLineForFeatureID:(unsigned long long)arg1 ;
...
-(SCD_Struct_GE140*)lineVertices;
-(SCD_Struct_GE152*)curveLineVertices;
-(SCD_Struct_GE150*)pointsOnRoad;
...
-(SCD_Struct_GE164*)transitAccessPointForFeatureID:(unsigned long long)arg1 ;
-(SCD_Struct_GE160*)transitSystemInfoForFeatureID:(unsigned long long)arg1 ;
-(GEOTileLabelLine*)tileLabelLineforLabelLineID:(unsigned long long)arg1 ;
-(SCD_Struct_GE139*)linesLabelAnnotations;
-(unsigned long long)linesLabelAnnotationCount;
-(SCD_Struct_GE140*)linesAnnotationBezierVertices;
-(SCD_Struct_GE69*)coastlines;
-(unsigned long long)coastlinesCount;
-(SCD_Struct_GE142*)venues;
-(unsigned long long)venuesCount;
-(SCD_Struct_GE143*)venueBuildings;
-(unsigned long long)venueBuildingsCount;
-(SCD_Struct_GE144*)venueLevels;
-(unsigned long long)venueLevelsCount;
-(SCD_Struct_GE145*)venueComponents;
-(unsigned long long)venueComponentsCount;
-(SCD_Struct_GE140*)venueVertices;
...
-(SCD_Struct_GE140*)transitStationTransferVertices;
-(SCD_Struct_GE163*)transitStationTransfers;
-(unsigned long long)transitStationTransferCount;
-(SCD_Struct_GE135*)transitJunctions;
...
-(SCD_Struct_GE139*)transitLinkLabelAnnotations;
-(unsigned long long)transitLinkLabelAnnotationCount;
-(SCD_Struct_GE140*)transitLinkAnnotationBezierVertices;
...
-(SCD_Struct_GE146*)threeDBuildings;
-(SCD_Struct_GE146*)overlapThreeDBuildings;
...
-(BOOL)_readPolygons:(SCD_Struct_GE166*)arg1 ofType:(unsigned short)arg2 ;
-(BOOL)_readLowResBuildings:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readWrappingCoastlines:(SCD_Struct_GE168*)arg1 tile:(SCD_Struct_GE166*)arg2 ;
-(BOOL)_readSimpleCoastlines:(SCD_Struct_GE168*)arg1 tile:(SCD_Struct_GE166*)arg2 ;
-(BOOL)_readChapter3DBuildings:(SCD_Struct_GE166*)arg1 chapter:(unsigned short)arg2 buildingFeatures:(/*function pointer*/void**)arg3 count:(unsigned long long*)arg4 ;
-(BOOL)_readModernBuildings:(SCD_Struct_GE166*)arg1 chapter:(unsigned short)arg2 vertexPool:(/*function pointer*/void**)arg3 footprints:(/*function pointer*/void**)arg4 count:(unsigned long long*)arg5 ;
-(BOOL)_readTransitSystemsChapterIDSet:(SCD_Struct_GE167*)arg1 featureCount:(unsigned long long)arg2 handler:(/*^block*/id)arg3 ;
-(BOOL)_readTransitSystemsChapterLabelSet:(SCD_Struct_GE167*)arg1 featureCount:(unsigned long long)arg2 handler:(/*^block*/id)arg3 ;
...
-(BOOL)_decodeTransitLabelsFromStream:(SCD_Struct_GE167*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE41*)arg3 featureStride:(unsigned long long)arg4 ;
-(BOOL)_decodeLabelTextPlacementsFromStream:(SCD_Struct_GE167*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE43*)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5 ;
-(BOOL)_readConnectivity:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_addGenericPolygonWithAttributes:(int*)arg1 ;
-(BOOL)_handleGenericTile:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readInfoChapter:(SCD_Struct_GE166*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_readLabels:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readPois:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readLines:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readPolygons:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readVenues:(SCD_Struct_GE166*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_readCoastlines:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_read3DBuildings:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readBorder3DBuildings:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readLowResBorderBuildings:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readHighResBuildings:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readTileReferences:(SCD_Struct_GE166*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_readTransitNetwork:(SCD_Struct_GE166*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_readTransitSystems:(SCD_Struct_GE166*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_populateTransitNodeStyleAttributes;
-(BOOL)_readExtendedPointAttributes:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readTransitMZROverride:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readVenueMZROverride:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readCoverage:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readLabelPlacementMetadata:(SCD_Struct_GE166*)arg1 ;
-(BOOL)_readLabelAnnotations:(SCD_Struct_GE166*)arg1 key:(const GEOTileKey*)arg2 forLines:(BOOL)arg3 ;
-(BOOL)_readRoadNetwork:(SCD_Struct_GE166*)arg1 ;
-(void)dealloc;
-(id)description;
@end
