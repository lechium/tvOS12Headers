...
@class PLCloudBatchUploader, PLCloudBatchDownloader, NSObject, PLBatterySaverWatcher, PLPhotoLibrary, CPLLibraryManager, PLCloudTaskManager, PLCloudResourceManager, NSDate, PFCoalescer, PLCloudInMemoryTaskManager, PLCloudPhotoLibraryUploadTracker, NSMutableDictionary, NSNumber, NSString;
