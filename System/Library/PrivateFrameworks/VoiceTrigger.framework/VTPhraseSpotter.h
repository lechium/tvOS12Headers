...
@class VTAnalyzerNDAPI, NSArray, NSString, CSAudioCircularBuffer, NSDateFormatter, NSObject, VTSiriNotifications, VTTranscriber, VTTextDependentSpeakerRecognizer, NSMutableArray, VTCorruptDetector, NSData, NSDictionary, NSDate, VTPhraseSpotterEnabledPolicy, VTAudioFileReader;
