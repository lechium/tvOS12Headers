...
@class RPCompanionLinkClient, NSObject, SFClient, SFService, SFSession, SFSiriClient, SFSiriDeviceSetupGreetingDetails, HMDeviceSetupOperationHandler, SFDeviceOperationHandlerWiFiSetup, CUAudioPlayer, NSString, NSDate;
