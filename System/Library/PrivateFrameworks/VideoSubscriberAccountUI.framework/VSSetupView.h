...
@interface VSSetupView : UIView {
	...
	BOOL _shouldShowTvAppGdprButton;
...
@property (assign,nonatomic) BOOL shouldShowTvAppGdprButton;                           //@synthesize shouldShowTvAppGdprButton=_shouldShowTvAppGdprButton - In the implementation block
...
-(BOOL)shouldShowTvAppGdprButton;
-(void)setShouldShowTvAppGdprButton:(BOOL)arg1 ;
