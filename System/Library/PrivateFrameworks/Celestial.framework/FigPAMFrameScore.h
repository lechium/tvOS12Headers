...
+(BOOL)computeFrameScoreFeatureVector:(float)arg1 afScore:(float)arg2 face:(const SCD_Struct_Fi98*)arg3 result:(float*)arg4 ;
...
-(BOOL)detectFace:(int)arg1 image:(CVBufferRef)arg2 meta:(id)arg3 useFocusRegion:(BOOL)arg4 faceRectangles:(const CGRect*)arg5 faceRectangleCount:(int)arg6 toImageTransform:(CGAffineTransform)arg7 result:(SCD_Struct_Fi98*)arg8 ;
