...
-(id)_clientBracketSettingsWithCurrentFrameStats:(SCD_Struct_BW31*)arg1 stillImageSettings:(id)arg2 ;
-(int)_captureTypeForSettings:(id)arg1 frameStatistics:(SCD_Struct_BW31*)arg2 captureFlags:(unsigned long long*)arg3 ;
