...
@interface FigCaptureImageMotionDetector : NSObject {
	...
	int* _intRowSum;
	int* _intColSum;
	SCD_Struct_Fi99* _imgProj;
	SCD_Struct_Fi102 _gyroDataCtx;
	SCD_Struct_Fi103 _hallDataCtx;
	SCD_Struct_Fi104* _transformCtx;
	SCD_Struct_BW87 _cameraData;
	double* _tmpSum1;
	double* _tmpSum2;
	double* _corrArray;
	int _rowSumLength;
	...
	SCD_Struct_Fi105 _motionStatistics;
...
-(SCD_Struct_Fi109)_extractMotionMetadata:(id)arg1 ;
