...
+(void)initialize;
-(void)_updateSceneChangeMonitorWithFrameStatistics:(SCD_Struct_BW31*)arg1 fromMasterStream:(id)arg2 zoomFactor:(float)arg3 ;
-(id)_preferredMasterStreamForZoomFactor:(float)arg1 frameStatistics:(SCD_Struct_BW31*)arg2 ;
-(BOOL)_selectionBehaviorAllowsSwitchOverForFrameStatistics:(SCD_Struct_BW31*)arg1 zoomFactor:(float)arg2 ;
-(void)_attemptLockWithFrameStatistics:(SCD_Struct_BW31*)arg1 ;
-(BOOL)telephotoLimitsReached:(SCD_Struct_BW31*)arg1 ;
-(BOOL)_exposureAndFocusStableForSwitchOverForFrameStatistics:(SCD_Struct_BW31*)arg1 ;
...
-(id)recommendMasterStreamUsingCurrentMasterStream:(id)arg1 frameStatistics:(SCD_Struct_BW31*)arg2 zoomFactor:(float)arg3 ;
