...
@class BWInferenceScheduler, BWInferenceDependencyProvider, BWEspressoInferenceAdapter, BWEspressoInferenceContext, BWFigVideoCaptureDevice, NSMutableArray, NSMutableDictionary, NSMutableSet, NSDictionary, NSString;
...
-(int)addInferenceOfType:(int)arg1 version:(SCD_Struct_BW84)arg2 configuration:(id)arg3 ;
