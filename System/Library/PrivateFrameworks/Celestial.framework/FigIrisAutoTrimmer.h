...
@interface FigIrisAutoTrimmer : NSObject {
	...
	SCD_Struct_Fi81 _captureMotionDelta;
	double _captureMotionDeltaPeriod;
	BOOL _haveCaptureMotionDelta;
	SCD_Struct_Fi81 _lastAttitude;
	SCD_Struct_Fi81 _lastDelta;
...
-(void)_processMotionSample:(const SCD_Struct_Fi81*)arg1 gravity:(const SCD_Struct_Fi80*)arg2 motionTimestamp:(double)arg3 frameTimestamp:(SCD_Struct_BW2)arg4 metadata:(id)arg5 ;
