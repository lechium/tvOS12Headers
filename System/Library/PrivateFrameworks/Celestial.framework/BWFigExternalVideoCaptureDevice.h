...
-(int)setWhiteBalanceModeLockedWithGains:(SCD_Struct_BW30)arg1 requestID:(int)arg2 ;
-(SCD_Struct_BW30)deviceWhiteBalanceGains;
-(SCD_Struct_BW30)grayWorldDeviceWhiteBalanceGains;
