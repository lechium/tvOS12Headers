...
@class NSObject, CURunLoopThread, NSDate, MRExternalClientConnection, _MROriginProtobuf, _MRDeviceInfoMessageProtobuf, _MRNowPlayingPlayerPathProtobuf, NSDictionary, NSData, _MRContentItemProtobuf, MRExternalDeviceTransport, NSString;
