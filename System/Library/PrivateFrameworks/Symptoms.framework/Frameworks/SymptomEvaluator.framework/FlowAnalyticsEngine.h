...
@class UsageAnalytics, ProcessAnalytics, AppAnalytics, ObjectAnalytics, NSMutableDictionary, ImpoExpoService, NSMutableSet, NSObject, NSDate, BKSApplicationStateMonitor, FBSDisplayLayoutMonitor, RepeatedConnFailureDetector;
...
-(void)_checkCellExcessUsageActions:(unsigned long long)arg1 previous:(unsigned long long)arg2 snapshot:(id)arg3 socketClosed:(BOOL)arg4 ;
