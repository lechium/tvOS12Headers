...
@interface TrackedFlow : TrackedFlowCounts {
	...
	SCD_Struct_Tr34* _currentActivityMap;
	BOOL _closedOut;
	BOOL _isNiced;
	BOOL _isRNF;
...
@property (readonly) SCD_Struct_Tr34* currentActivityMap;                                     //@synthesize currentActivityMap=_currentActivityMap - In the implementation block
+(void)dumpState;
...
-(SCD_Struct_Tr34*)currentActivityMap;
