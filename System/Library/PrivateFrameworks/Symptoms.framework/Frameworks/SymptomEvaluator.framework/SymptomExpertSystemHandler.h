...
@class NSMutableDictionary, SymptomExpertSystemState, NSArray, SystemSettingsRelay, PowerStateRelay, NetworkAnalyticsStateRelay, CellFallbackHandler, SystemProperties, NSDate, NSSet, MotionStateRelay, NSString, CLIPSShim, NSMutableArray, NSDataDetector, AWDObserver, AnalyticsConfigurationObserver, NSObject, ProbeManager, SDRDiagnosticReporter, NSXPCConnection, SymptomsFileCleaner;

@interface SymptomExpertSystemHandler : ExpertSystemHandlerCore <ProbeManagerDelegate, CLIPSShimDelegate, WiFiShimDelegate, SymptomsFileCleanerDelegate, AWDObserverDelegate, AnalyticsConfigurationObserverDelegate> {
	...
	SCD_Struct_Sy8 wifiRelayContext;
	SCD_Struct_Sy8 wifiScalarRelayContext;
	SCD_Struct_Sy8 cellRelayContext;
	SCD_Struct_Sy8 cellScalarRelayContext;
	SCD_Struct_Sy8 systemRelayContext;
	SCD_Struct_Sy8 systemScalarRelayContext;
	SCD_Struct_Sy8 systemSymptomRelayContext;
	SCD_Struct_Sy8 hardwareRelayContext;
	NSString* _airdropID;
