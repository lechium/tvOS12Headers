...
-(SCD_Struct_Ne23)_parseTimeIntoWeekdayAndSlotId:(long long)arg1 withReferenceDate:(id)arg2 ;
-(void)_processNetworkState:(SCD_Struct_Ne24*)arg1 toStateSet:(id)arg2 stateStartTimeInfo:(SCD_Struct_Ne23)arg3 stateEndTimeInfo:(SCD_Struct_Ne23)arg4 effectiveNetworkId:(id)arg5 ;
...
-(SCD_Struct_Ne25)_calculateStatisticsFromNetworkStateTable:(id)arg1 usingPredicate:(id)arg2 ;
