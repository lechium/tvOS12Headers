...
@interface VCAudioTransmitter : NSObject <VCAudioIOSink, VCConnectionChangedHandler> {
	...
	SCD_Struct_VC101 _currentChannelMetrics;
	SCD_Struct_VC134 _idsChannelDataFormat;
...
@property (assign,nonatomic) SCD_Struct_VC101 currentChannelMetrics;                          //@synthesize currentChannelMetrics=_currentChannelMetrics - In the implementation block
...
-(SCD_Struct_VC101)currentChannelMetrics;
...
-(void)setCurrentChannelMetrics:(SCD_Struct_VC101)arg1 ;
-(void)dealloc;
