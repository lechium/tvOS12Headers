...
@interface VCBasebandMetrics : NSObject {
	...
	SCD_Struct_VC75 _lastBasebandNotification;
	double _bdcd;
	double _normalizedBDCD;
	double _normalizedDelay;
	BOOL _isBDCDListReady;
	SCD_Struct_VC76 _bdcdList;
	SCD_Struct_VC77 _infoList;
...
-(void)resetBDCDList;
-(SCD_Struct_AV19)getBasebandMetricsWithNotification:(SCD_Struct_VC78*)arg1 ;
