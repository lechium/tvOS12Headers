...
-(int)getKeyDerivationCryptoSet:(SCD_Struct_VC114*)arg1 withKeyMaterial:(id)arg2 derivedSSRC:(unsigned*)arg3 ;
-(int)updateEncryption:(SCD_Struct_VC114*)arg1 derivedSSRC:(unsigned)arg2 ;
...
-(void)messageReceived:(id)arg1 participantInfo:(SCD_Struct_VC115*)arg2 ;
