...
* on Friday, May 31, 2019 at 10:57:48 AM Mountain Standard Time
...
@interface AWDWiFiMetricLinkChangeData : PBCodable <NSCopying> {
	...
	SCD_Struct_AW14* _bcnFrmsHistorys;
	SCD_Struct_AW14* _bcnPerHistorys;
	SCD_Struct_AW14* _fwTxFrmsHistorys;
	SCD_Struct_AW14* _fwTxPerHistorys;
	SCD_Struct_AW14* _rssiHistorys;
	SCD_Struct_AW14* _txFrmsHistorys;
	SCD_Struct_AW14* _txPerHistorys;
