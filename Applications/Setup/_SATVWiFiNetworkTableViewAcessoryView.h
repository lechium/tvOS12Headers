...
- (void).cxx_destruct;	// IMP=0x000000010002b64c
- (void)setTintColor:(id)arg1;	// IMP=0x000000010002b58c
- (void)layoutSubviews;	// IMP=0x000000010002b1e0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010002b114
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002adbc
