...
- (void).cxx_destruct;	// IMP=0x0000000100021ca0
- (void)tableView:(id)arg1 didUnfocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100021acc
- (void)tableView:(id)arg1 didFocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100021a38
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00000001000217fc
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00000001000213f8
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00000001000213d0
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00000001000213c8
@property(readonly, nonatomic) struct CGSize sizeThatFits;
- (id)preferredFocusEnvironments;	// IMP=0x00000001000212a0
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000210a4
- (void)loadView;	// IMP=0x0000000100020bf4
