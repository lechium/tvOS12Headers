...
- (void).cxx_destruct;	// IMP=0x0000000100030358
- (id)description;	// IMP=0x00000001000301c8
- (id)init;	// IMP=0x00000001000301b0
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x00000001000300d0
