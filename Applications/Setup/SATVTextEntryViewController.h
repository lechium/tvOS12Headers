...
- (void).cxx_destruct;	// IMP=0x0000000100004568
- (void)_submitButtonAction:(id)arg1;	// IMP=0x0000000100004384
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00000001000042d8
- (void)_textChanged;	// IMP=0x00000001000041c0
- (id)preferredFocusEnvironments;	// IMP=0x0000000100004148
- (void)_doneButtonPressed:(id)arg1;	// IMP=0x0000000100003cf4
- (_Bool)_enableAutomaticKeyboardPressDone;	// IMP=0x0000000100003cec
- (_Bool)_disableAutomaticKeyboardUI;	// IMP=0x0000000100003ce4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100003c54
- (void)loadView;	// IMP=0x000000010000371c
