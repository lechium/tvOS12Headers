...
- (void).cxx_destruct;	// IMP=0x0000000100080fd8
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000100080df4
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x0000000100080bec
- (void)layoutSubviews;	// IMP=0x0000000100080ae4
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x0000000100080a84
