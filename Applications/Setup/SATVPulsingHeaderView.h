...
- (void).cxx_destruct;	// IMP=0x0000000100080a74
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000100080890
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x000000010008016c
- (void)layoutSubviews;	// IMP=0x0000000100080064
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x0000000100080004
