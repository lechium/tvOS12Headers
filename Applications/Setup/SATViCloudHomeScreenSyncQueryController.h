...
+ (_Bool)isSupported;	// IMP=0x000000010007fbf0
+ (id)stableKey;	// IMP=0x000000010007fb64
...
- (void).cxx_destruct;	// IMP=0x000000010007ffb0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010007fd74
- (void)viewDidLoad;	// IMP=0x000000010007fc70
- (void)reset;	// IMP=0x000000010007fc58
- (id)init;	// IMP=0x000000010007fb74
