...
- (void).cxx_destruct;	// IMP=0x000000010001f60c
- (void)didFinishAnimationPulsingAnimation:(id)arg1;	// IMP=0x000000010001f1e0
- (void)setManualTitle:(id)arg1 subtitle:(id)arg2;	// IMP=0x000000010001f004
- (unsigned long long)_nextUniqueStringIndex;	// IMP=0x000000010001edec
- (_Bool)_supportsCycling;	// IMP=0x000000010001ed9c
- (void)_stopAutoAdvanceTimer;	// IMP=0x000000010001ed58
- (void)_startAutoAdvanceTimer;	// IMP=0x000000010001ebc4
- (void)_cycleAtBeginTime:(double)arg1;	// IMP=0x000000010001ea2c
- (void)cycleAtBeginTime:(double)arg1;	// IMP=0x000000010001e9e8
- (void)cycleWithInterval:(double)arg1;	// IMP=0x000000010001e9d0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010001e968
- (void)layoutSubviews;	// IMP=0x000000010001e8c0
- (void)dealloc;	// IMP=0x000000010001e808
- (id)initWithTitleStrings:(id)arg1 subtitleStrings:(id)arg2 languageCodes:(id)arg3;	// IMP=0x000000010001e234
