...
+ (_Bool)isSupported;	// IMP=0x000000010003a148
+ (id)stableKey;	// IMP=0x000000010003a0bc
...
- (void).cxx_destruct;	// IMP=0x000000010003a8d8
- (void)_startRequestTimeoutTimer;	// IMP=0x000000010003a630
- (void)_cancelRequestTimeoutTimer;	// IMP=0x000000010003a544
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010003a2b4
- (void)viewDidLoad;	// IMP=0x000000010003a1b0
- (id)init;	// IMP=0x000000010003a0cc
