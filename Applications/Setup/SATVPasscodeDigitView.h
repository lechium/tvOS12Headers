...
- (id)hiddenDigitImage;	// IMP=0x0000000100029fec
- (id)arrowImage:(_Bool)arg1;	// IMP=0x0000000100029ddc
- (void)downGesture:(id)arg1;	// IMP=0x0000000100029c94
- (void)upGesture:(id)arg1;	// IMP=0x0000000100029b60
@property(copy, nonatomic) NSString *text;
- (void)setHighlightProgress:(double)arg1;	// IMP=0x0000000100029a54
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000298f4
- (_Bool)canBecomeFocused;	// IMP=0x00000001000298ec
- (void)layoutSubviews;	// IMP=0x000000010002964c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100028ef8
