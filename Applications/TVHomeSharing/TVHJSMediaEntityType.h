...
- (void).cxx_destruct;	// IMP=0x0000000100028488
...
- (id)initWithMediaEntityType:(id)arg1 appContext:(id)arg2;	// IMP=0x000000010002806c
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100027fe4
- (id)init;	// IMP=0x0000000100027f5c
