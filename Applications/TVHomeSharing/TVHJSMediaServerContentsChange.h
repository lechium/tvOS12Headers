...
- (void).cxx_destruct;	// IMP=0x0000000100030588
...
- (id)initWithContentsChange:(id)arg1 appContext:(id)arg2;	// IMP=0x00000001000303d8
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100030350
- (id)init;	// IMP=0x00000001000302c8
