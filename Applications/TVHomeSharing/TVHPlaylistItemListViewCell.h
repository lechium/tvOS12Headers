...
- (void).cxx_destruct;	// IMP=0x000000010002b780
- (void)layoutSubviews;	// IMP=0x000000010002b408
- (void)_updateColors;	// IMP=0x000000010002b238
- (void)updateWithViewElement:(id)arg1;	// IMP=0x000000010002ab00
