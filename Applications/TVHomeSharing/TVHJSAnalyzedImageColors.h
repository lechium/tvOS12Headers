...
- (void).cxx_destruct;	// IMP=0x0000000100036fb8
@property(readonly, nonatomic) _Bool isBackgroundLight;
- (id)initWithAnalyzedImageColors:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000100036ec0
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100036e38
