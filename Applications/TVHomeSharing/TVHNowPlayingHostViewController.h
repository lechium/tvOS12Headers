...
- (void).cxx_destruct;	// IMP=0x000000010000d740
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010000d644
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010000d4d8
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000010000d450
