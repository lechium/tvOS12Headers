...
+ (id)appCardViewFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x0000000100005b70
...
- (void).cxx_destruct;	// IMP=0x000000010000829c
- (struct UIEdgeInsets)selectionMarginsForSize:(struct CGSize)arg1;	// IMP=0x00000001000080c4
- (void)layoutSubviews;	// IMP=0x00000001000078b8
- (void)applyFocusedLayout;	// IMP=0x0000000100007564
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100006ca4
- (unsigned long long)_primaryStateForState:(unsigned long long)arg1;	// IMP=0x0000000100006c78
@property(nonatomic, getter=isSelected) _Bool selected;
- (void)_updateForAccessibilityChange;	// IMP=0x00000001000067f8
- (void)dealloc;	// IMP=0x0000000100006780
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100006504
