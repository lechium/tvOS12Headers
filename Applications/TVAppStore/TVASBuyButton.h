...
- (void)_selectButtonAction:(id)arg1;	// IMP=0x000000010000b98c
- (id)_contentView;	// IMP=0x000000010000b938
- (_Bool)_shouldShowPie;	// IMP=0x000000010000b914
- (id)_pieLayerWithDiameter:(double)arg1;	// IMP=0x000000010000b7e8
- (id)_progressPieLayerWithDiameter:(double)arg1;	// IMP=0x000000010000b510
- (id)_spinningPieLayerWithDiameter:(double)arg1;	// IMP=0x000000010000b3d0
- (void)_updatePieLayers;	// IMP=0x000000010000af3c
- (void)_removePieLayers;	// IMP=0x000000010000ae84
- (void)_installPieLayers;	// IMP=0x000000010000aa90
- (void)_updateButtonAppearance;	// IMP=0x000000010000a834
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000010000a7dc
- (void)layoutSubviews;	// IMP=0x000000010000a364
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010000a2e8
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010000a1d8
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010000a0f4
- (void)setBuyButtonState:(long long)arg1 withProgress:(double)arg2;	// IMP=0x0000000100009e74
- (void)dealloc;	// IMP=0x000000010000921c
- (id)initWithFrame:(struct CGRect)arg1 backdropStyle:(long long)arg2 textVibrancyStyle:(long long)arg3;	// IMP=0x0000000100008d3c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100008d28
- (void)tvas_configureWithViewElement:(id)arg1 suppressUpdate:(_Bool)arg2;	// IMP=0x0000000100010ecc
- (void)tvas_configureWithViewElement:(id)arg1;	// IMP=0x0000000100010ebc
