...
- (void).cxx_destruct;	// IMP=0x000000010000cd84
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000cbb8
- (id)copyAfterAppUpdate;	// IMP=0x000000010000cb7c
...
- (id)initWithViewElement:(id)arg1 pricingText:(id)arg2 actionTitle:(id)arg3;	// IMP=0x000000010000c330
