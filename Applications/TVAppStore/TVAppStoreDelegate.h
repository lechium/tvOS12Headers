...
- (void).cxx_destruct;	// IMP=0x0000000100012a9c
- (Class)collectionViewCellClassForElement:(id)arg1;	// IMP=0x00000001000129d4
- (id)viewForElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00000001000127e4
- (void)appController:(id)arg1 evaluateAppJavaScriptInContext:(id)arg2;	// IMP=0x0000000100012634
