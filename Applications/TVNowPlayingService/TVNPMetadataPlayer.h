...
- (void).cxx_destruct;	// IMP=0x000000010000c63c
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x000000010000c058
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x000000010000c048
- (void)_updateElapsedTimeTimer;	// IMP=0x000000010000bf60
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x000000010000bb34
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x000000010000b840
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x000000010000b83c
- (void)updateSubtitleOptions;	// IMP=0x000000010000b838
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000b834
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000b82c
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000b824
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000b7a4
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x000000010000b6d0
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x000000010000b670
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x000000010000b664
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x000000010000b658
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x000000010000b64c
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000010000b54c
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000b540
- (void)stop;	// IMP=0x000000010000b4b0
- (void)scanWithRate:(double)arg1;	// IMP=0x000000010000b318
- (void)togglePlayPause;	// IMP=0x000000010000b2d0
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000b2c4
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000b2b8
- (void)pause;	// IMP=0x000000010000b270
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000b264
- (void)play;	// IMP=0x000000010000b134
- (void)continueLoadingCurrentItem;	// IMP=0x000000010000b130
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x000000010000b0a4
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x000000010000b094
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x000000010000b030
- (void)invalidate;	// IMP=0x000000010000aff4
- (id)initWithName:(id)arg1;	// IMP=0x000000010000aedc
- (id)init;	// IMP=0x000000010000aecc
