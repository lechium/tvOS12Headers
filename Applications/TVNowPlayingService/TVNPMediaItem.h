...
- (void).cxx_destruct;	// IMP=0x0000000100011804
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x000000010001163c
- (void)replaceMediaItemMetadata:(id)arg1 forProperty:(id)arg2;	// IMP=0x00000001000115d0
