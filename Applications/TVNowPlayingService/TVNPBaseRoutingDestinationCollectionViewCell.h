...
+ (id)_iconImageForDeviceType:(unsigned long long)arg1 focused:(_Bool)arg2;	// IMP=0x000000010001aafc
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0000000100019674
...
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010001a51c
- (unsigned long long)_controlStateForCell;	// IMP=0x000000010001a498
- (void)_addInitialConstraints;	// IMP=0x00000001000197c4
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000100019114
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000100019028
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000100019024
- (void)updateConstraints;	// IMP=0x0000000100018a64
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010001896c
- (void)useFocusedAppearance;	// IMP=0x0000000100018958
- (void)layoutSubviews;	// IMP=0x00000001000187a0
- (void)prepareForReuse;	// IMP=0x0000000100018744
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100017fbc
