...
+ (id)arrayChangeMove:(unsigned long long)arg1 toIndex:(unsigned long long)arg2;	// IMP=0x000000010001b038
+ (id)arrayChangeDelete:(id)arg1;	// IMP=0x000000010001af88
+ (id)arrayChangeInsert:(id)arg1;	// IMP=0x000000010001aedc
