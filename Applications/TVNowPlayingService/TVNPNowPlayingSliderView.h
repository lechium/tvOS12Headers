...
- (void).cxx_destruct;	// IMP=0x000000010000215c
- (id)_unfocusedProgressColor;	// IMP=0x0000000100001ffc
- (id)_focusedProgressColor;	// IMP=0x0000000100001f70
- (void)_panUpdated:(id)arg1;	// IMP=0x0000000100001d0c
- (void)_menuPressed;	// IMP=0x0000000100001d08
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100001d04
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100001cfc
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100001cf4
- (_Bool)shouldTrack;	// IMP=0x0000000100001cec
- (double)maxBarWidth;	// IMP=0x0000000100001cdc
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x0000000100001cb4
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100001a68
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100001a40
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000100001a2c
- (void)layoutSubviews;	// IMP=0x00000001000017e8
- (_Bool)canBecomeFocused;	// IMP=0x00000001000017e0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100001330
