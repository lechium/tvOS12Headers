...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x000000010001ecd4
...
- (id)_placeholderArtwork;	// IMP=0x000000010002182c
- (void)_updateState;	// IMP=0x0000000100021690
- (void)_updateAutomaticResponseLoading;	// IMP=0x00000001000215c0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x00000001000210ac
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000100020f80
- (void)_updateMetadata;	// IMP=0x000000010001fb20
- (void)_createRequestController;	// IMP=0x000000010001f63c
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x000000010001f3f0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000010001f270
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x000000010001ee90
- (void)playPause;	// IMP=0x000000010001ee7c
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x000000010001ee18
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010001ed60
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x000000010001ec78
- (id)playerPath;	// IMP=0x000000010001ebc4
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x000000010001ea84
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x000000010001e7d8
