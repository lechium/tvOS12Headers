...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00000001000072f0
...
- (void).cxx_destruct;	// IMP=0x000000010000a52c
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000100008fe8
- (void)_updateAvailableRoutes;	// IMP=0x0000000100008a28
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x00000001000088a4
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000100008898
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x000000010000888c
- (void)targetDestination:(id)arg1;	// IMP=0x0000000100008734
- (void)unpickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000100008380
- (void)pickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000100007bf8
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000100007b44
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100007394
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000100007384
- (id)init;	// IMP=0x0000000100007370
