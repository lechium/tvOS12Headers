...
- (void)decline:(id)arg1;	// IMP=0x000000010001a07c
- (void)challengeOK:(id)arg1;	// IMP=0x000000010001a068
- (void)play:(id)arg1;	// IMP=0x000000010001a010
- (void)updateLeaderboardImage;	// IMP=0x0000000100019fc0
- (void)configureForChallenge;	// IMP=0x0000000100019ad0
- (id)preferredFocusEnvironments;	// IMP=0x0000000100019a4c
- (void)viewDidLoad;	// IMP=0x0000000100019948
- (void)dealloc;	// IMP=0x00000001000198f0
- (id)initWithChallenge:(id)arg1;	// IMP=0x000000010001982c
