...
+ (id)highRankNib;	// IMP=0x000000010001ec04
+ (id)lowRankNib;	// IMP=0x000000010001ebd8
+ (struct CGSize)defaultSize;	// IMP=0x000000010001ebc4
...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010001f050
@property(nonatomic) _Bool linesVisible; // @dynamic linesVisible;
- (void)setupForScore:(id)arg1;	// IMP=0x000000010001eea4
@property(readonly, nonatomic) UIView *popoverSourceView;
- (void)dealloc;	// IMP=0x000000010001eda8
- (void)awakeFromNib;	// IMP=0x000000010001ec30
