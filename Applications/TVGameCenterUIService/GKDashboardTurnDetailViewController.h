...
- (void)handleTurnBasedEvent:(id)arg1;	// IMP=0x0000000100016dc8
- (void)turnOK:(id)arg1;	// IMP=0x0000000100016db4
- (void)removeMatch:(id)arg1;	// IMP=0x0000000100016adc
- (void)quitMatch:(id)arg1;	// IMP=0x000000010001655c
- (void)disableButtons;	// IMP=0x00000001000164fc
- (void)chooseMatch:(id)arg1;	// IMP=0x0000000100016280
- (void)declineInvitation:(id)arg1;	// IMP=0x0000000100015fa8
- (void)acceptInvitation:(id)arg1;	// IMP=0x0000000100015d48
- (void)refreshPresenter;	// IMP=0x0000000100015cdc
- (id)preferredFocusEnvironments;	// IMP=0x0000000100015c58
- (id)playingWithString;	// IMP=0x0000000100015978
- (void)viewDidLoad;	// IMP=0x0000000100015280
- (void)dealloc;	// IMP=0x0000000100015204
- (id)initWithTurnBasedMatch:(id)arg1;	// IMP=0x00000001000150c0
