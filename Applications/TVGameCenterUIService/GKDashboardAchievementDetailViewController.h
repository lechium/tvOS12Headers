...
- (void)share:(id)arg1;	// IMP=0x00000001000095a8
- (void)challenge:(id)arg1;	// IMP=0x00000001000094a4
- (void)configureForAchievements;	// IMP=0x0000000100008c60
- (id)preferredFocusEnvironments;	// IMP=0x0000000100008bdc
- (void)viewDidLoad;	// IMP=0x0000000100008b44
- (void)dealloc;	// IMP=0x0000000100008ad4
- (id)initWithAchievement:(id)arg1 localAchievement:(id)arg2;	// IMP=0x00000001000089f8
