...
- (_Bool)isInGame;	// IMP=0x00000001000134ec
- (void)launchGameAndShowMatch:(id)arg1;	// IMP=0x0000000100013460
- (void)showMatch:(id)arg1;	// IMP=0x0000000100013360
- (void)notifyGameWithMatch:(id)arg1 orError:(id)arg2;	// IMP=0x0000000100012f8c
- (void)turnBasedInviteViewController:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x0000000100012f7c
- (void)turnBasedInviteViewController:(id)arg1 didCreateMatchID:(id)arg2;	// IMP=0x0000000100012eb4
- (void)turnBasedInviteViewControllerWasCancelled:(id)arg1;	// IMP=0x0000000100012e14
- (id)collectionView:(id)arg1 viewForSupplementaryElementOfKind:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x0000000100012d0c
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x0000000100012c90
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000100012be8
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x0000000100012b14
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x0000000100012ad8
- (long long)numberOfSectionsInCollectionView:(id)arg1;	// IMP=0x0000000100012ad0
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0000000100012abc
- (void)finishWithError:(id)arg1;	// IMP=0x0000000100012a58
- (void)didPressNewGameButton:(id)arg1;	// IMP=0x0000000100012a48
- (_Bool)hasData;	// IMP=0x00000001000129e8
- (void)loadData;	// IMP=0x00000001000123fc
- (id)preferredFocusEnvironments;	// IMP=0x000000010001235c
- (void)showInviteControllerAnimated:(_Bool)arg1;	// IMP=0x0000000100012250
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000100012170
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100012108
- (void)didPressMenuButton;	// IMP=0x0000000100012030
- (void)viewDidLoad;	// IMP=0x0000000100011dc4
- (id)initWithMatchRequest:(id)arg1;	// IMP=0x0000000100011cf8
- (void)dealloc;	// IMP=0x0000000100011c38
