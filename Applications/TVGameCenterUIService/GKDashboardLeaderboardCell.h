...
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000001000141e8
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000100014160
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100013fb8
- (_Bool)canBecomeFocused;	// IMP=0x0000000100013fb0
- (void)updateOverlay;	// IMP=0x0000000100013f2c
- (void)updateImage;	// IMP=0x0000000100013bc8
- (void)updateRank;	// IMP=0x0000000100013a14
@property(readonly, nonatomic) UIView *popoverSourceView;
- (void)dealloc;	// IMP=0x0000000100013730
- (void)awakeFromNib;	// IMP=0x0000000100013658
