...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000010002e6c4
- (void)playersToInvite:(id)arg1;	// IMP=0x000000010002e68c
- (void)localPlayerAcceptedGameInvite:(id)arg1;	// IMP=0x000000010002e654
- (void)removedPlayer:(id)arg1;	// IMP=0x000000010002e650
- (void)invitePlayers:(id)arg1;	// IMP=0x000000010002e64c
- (void)cancel;	// IMP=0x000000010002e648
- (void)playNow;	// IMP=0x000000010002e644
- (id)preferredFocusEnvironments;	// IMP=0x000000010002e55c
- (void)didPressPlayButton;	// IMP=0x000000010002e3fc
- (void)didFinishPickingPlayers:(id)arg1;	// IMP=0x000000010002e308
- (void)didPressInviteButton;	// IMP=0x000000010002e0cc
- (void)willPresentPlayerPicker:(id)arg1;	// IMP=0x000000010002e0c8
- (long long)maxAvailablePlayers;	// IMP=0x000000010002e0a4
- (void)removePlayer:(id)arg1;	// IMP=0x000000010002dfd0
- (void)removeAutomatchPlayer;	// IMP=0x000000010002df8c
- (void)addAutomatchPlayer;	// IMP=0x000000010002df48
- (void)updatePlayerRangeLabel;	// IMP=0x000000010002de5c
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000010002de20
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010002dd90
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010002dccc
- (void)viewDidLoad;	// IMP=0x000000010002dab0
- (void)setupDataSourcePlayerChangeHandler;	// IMP=0x000000010002d714
- (void)configureDataSource;	// IMP=0x000000010002d368
@property(readonly, nonatomic) GKDashboardMultiplayerDataSource *multiplayerDataSource;
- (void)dealloc;	// IMP=0x000000010002d28c
- (id)initWithMatchRequest:(id)arg1;	// IMP=0x000000010002d118
- (id)init;	// IMP=0x000000010002cf6c
