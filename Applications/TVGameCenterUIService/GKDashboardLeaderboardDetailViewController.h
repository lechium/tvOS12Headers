...
- (void)report:(id)arg1;	// IMP=0x0000000100017ce0
- (void)share:(id)arg1;	// IMP=0x0000000100017b40
- (void)challenge:(id)arg1;	// IMP=0x000000010001795c
- (void)configureForScore;	// IMP=0x000000010001740c
- (id)preferredFocusEnvironments;	// IMP=0x0000000100017388
- (void)viewDidLoad;	// IMP=0x0000000100017154
- (void)dealloc;	// IMP=0x00000001000170e4
- (id)initWithScore:(id)arg1 leaderboard:(id)arg2;	// IMP=0x0000000100017008
