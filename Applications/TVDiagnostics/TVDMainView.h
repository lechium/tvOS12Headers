...
- (void)updateConstraints;	// IMP=0x0000000100008778
- (_Bool)displayDeviceIdentifier:(id)arg1;	// IMP=0x0000000100008704
- (_Bool)setDeviceIdentifierVisible:(_Bool)arg1;	// IMP=0x00000001000085e8
- (void)showCloseButtonWithDone:(_Bool)arg1;	// IMP=0x00000001000081e0
- (void)showButtonsAndApplicationTitle;	// IMP=0x0000000100008104
- (void)historyTapped:(id)arg1;	// IMP=0x00000001000080bc
- (void)doneTapped:(id)arg1;	// IMP=0x0000000100008074
- (void)closeTapped:(id)arg1;	// IMP=0x000000010000802c
- (void)hideProgressView:(_Bool)arg1;	// IMP=0x0000000100007fe4
- (void)updateProgress:(id)arg1;	// IMP=0x0000000100007f44
- (void)showActivityIndicator:(_Bool)arg1;	// IMP=0x0000000100007eec
- (void)hideText:(_Bool)arg1;	// IMP=0x0000000100007ea4
- (void)updateText:(id)arg1;	// IMP=0x0000000100007e38
- (void)updateWithDeviceState:(id)arg1;	// IMP=0x0000000100007dcc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100007094
