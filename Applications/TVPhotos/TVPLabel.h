...
- (void)_clearCachedValues;	// IMP=0x0000000100085630
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100085560
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x0000000100085420
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x00000001000853d0
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x0000000100085380
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x0000000100085330
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x00000001000852e0
- (void)setFont:(id)arg1;	// IMP=0x0000000100085290
- (void)setText:(id)arg1;	// IMP=0x0000000100085240
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100085178
