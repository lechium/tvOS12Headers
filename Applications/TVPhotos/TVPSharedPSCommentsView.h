...
- (void).cxx_destruct;	// IMP=0x0000000100017aec
- (id)_latestCommentIndexPathForCommentsView;	// IMP=0x000000010001791c
- (void)_scrollToLastComment;	// IMP=0x0000000100017898
- (void)layoutSubviews;	// IMP=0x0000000100017534
- (id)preferredFocusEnvironments;	// IMP=0x00000001000174a4
- (id)dequeueReusableViewForIdentifier:(id)arg1;	// IMP=0x0000000100017400
- (void)reloadCommentsData;	// IMP=0x00000001000173bc
- (void)registerClass:(Class)arg1 forCommentsWithReuseIdentifier:(id)arg2;	// IMP=0x00000001000172c8
- (void)registerClass:(Class)arg1 forSubheaderWithReuseIdentifier:(id)arg2;	// IMP=0x00000001000171e8
- (void)registerClass:(Class)arg1 forHeaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017108
