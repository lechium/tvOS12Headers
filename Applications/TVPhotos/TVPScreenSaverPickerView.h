...
- (void).cxx_destruct;	// IMP=0x0000000100067f5c
- (void)updateDelegate:(id)arg1;	// IMP=0x0000000100067ddc
- (void)tableView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100067d14
- (_Bool)tableView:(id)arg1 canFocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100067d0c
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000100067b34
- (id)init;	// IMP=0x0000000100066dfc
- (id)preferredFocusEnvironments;	// IMP=0x0000000100066d8c
