...
- (struct CGSize)_getAttributedStringSizeForText:(id)arg1 font:(id)arg2;	// IMP=0x00000001000878e0
- (void)layoutSubviews;	// IMP=0x0000000100087718
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100087478
