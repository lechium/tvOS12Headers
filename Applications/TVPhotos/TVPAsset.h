...
- (id)description;	// IMP=0x0000000100010410
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000102a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000101b0
- (unsigned long long)hash;	// IMP=0x0000000100010164
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100010098
