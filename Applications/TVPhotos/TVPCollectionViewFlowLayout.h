...
+ (Class)invalidationContextClass;	// IMP=0x000000010002c54c
+ (Class)layoutAttributesClass;	// IMP=0x000000010002c064
...
- (void)_removeFocusContainerGuideForSection:(long long)arg1;	// IMP=0x000000010002d0e8
- (id)_focusContainerGuideForSection:(long long)arg1;	// IMP=0x000000010002cf80
- (void)_updateFocusContainerGuides;	// IMP=0x000000010002cb88
- (struct CGSize)_titleAdjustmentSize;	// IMP=0x000000010002cb3c
- (struct CGRect)_titleFrame;	// IMP=0x000000010002c954
- (struct CGPoint)targetContentOffsetForProposedContentOffset:(struct CGPoint)arg1 withScrollingVelocity:(struct CGPoint)arg2;	// IMP=0x000000010002c5c8
- (struct CGSize)collectionViewContentSize;	// IMP=0x000000010002c560
- (void)invalidateLayoutWithContext:(id)arg1;	// IMP=0x000000010002c198
- (_Bool)shouldInvalidateLayoutForBoundsChange:(struct CGRect)arg1;	// IMP=0x000000010002c120
- (void)_adjustLayoutAttributes:(id)arg1;	// IMP=0x000000010002c078
- (void)_applyCustomAttributesToAttributes:(id)arg1;	// IMP=0x000000010002bf18
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000010002be94
- (id)layoutAttributesForSupplementaryViewOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x000000010002bd90
- (id)_layoutAttributesForTitle;	// IMP=0x000000010002bccc
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000010002b97c
- (void)prepareLayout;	// IMP=0x000000010002b854
