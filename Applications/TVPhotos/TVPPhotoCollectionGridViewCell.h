...
- (void).cxx_destruct;	// IMP=0x000000010000acdc
- (void)_updateLayoutProperties;	// IMP=0x000000010000a7ec
- (double)_focusedGrowthMagnitude;	// IMP=0x000000010000a778
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010000a340
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000a23c
@property(readonly, nonatomic) struct CGSize imageSize;
@property(retain, nonatomic) UIImage *badgeImage;
@property(copy, nonatomic) NSString *title;
- (double)cellCornerRadius;	// IMP=0x000000010000a108
- (void)prepareForReuse;	// IMP=0x000000010000a0ac
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100009a3c
