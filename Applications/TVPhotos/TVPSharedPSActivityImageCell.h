...
- (void).cxx_destruct;	// IMP=0x000000010008849c
- (void)layoutSubviews;	// IMP=0x0000000100087fbc
- (void)setTotalComments:(unsigned long long)arg1 commentBadge:(id)arg2;	// IMP=0x0000000100087c58
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100087ba0
- (void)_updatePlaceholderImage;	// IMP=0x0000000100087a98
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100087a40
