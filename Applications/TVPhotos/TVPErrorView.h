...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100005994
- (void)layoutSubviews;	// IMP=0x0000000100005764
- (void)_updateLabels;	// IMP=0x0000000100005664
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000052f8
