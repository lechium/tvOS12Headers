...
- (void).cxx_destruct;	// IMP=0x000000010000dda0
- (void)configureUIControls;	// IMP=0x000000010000d7d0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000d5b4
- (void)_onSelectSignIn:(id)arg1;	// IMP=0x000000010000d554
- (void)layoutSubviews;	// IMP=0x000000010000d150
- (id)preferredFocusEnvironments;	// IMP=0x000000010000cf80
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000cd18
