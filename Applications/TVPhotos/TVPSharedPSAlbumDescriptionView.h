...
- (void).cxx_destruct;	// IMP=0x0000000100061898
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100061784
- (void)layoutSubviews;	// IMP=0x00000001000614c8
- (void)_updatePlaceholderImage;	// IMP=0x00000001000613c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100061270
