...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x000000010005f490
- (void)_setImage:(id)arg1;	// IMP=0x000000010005f31c
- (id)_imageView;	// IMP=0x000000010005f184
- (void)_loadImage;	// IMP=0x000000010005ea30
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010005e8bc
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005e4cc
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000010005e3c0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010005e318
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000010005e2a4
- (void)setContentMode:(long long)arg1;	// IMP=0x000000010005e280
- (void)layoutSubviews;	// IMP=0x000000010005e214
- (long long)contentMode;	// IMP=0x000000010005e1fc
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010005e1e4
- (void)dealloc;	// IMP=0x000000010005e178
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005e08c
