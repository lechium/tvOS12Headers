...
+ (id)sharedInstance;	// IMP=0x000000010000ca10
...
- (void).cxx_destruct;	// IMP=0x000000010000ccc4
- (_Bool)loadCache;	// IMP=0x000000010000cb00
- (_Bool)hasFeedInfo;	// IMP=0x000000010000ca90
