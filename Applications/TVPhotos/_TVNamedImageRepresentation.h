...
- (id)_originalImageCacheKey;	// IMP=0x000000010000f3f8
- (struct CGImage *)_originalImage;	// IMP=0x000000010000f374
- (id)initWithImageNamed:(id)arg1 inBundle:(id)arg2 compatibleWithTraitCollection:(id)arg3;	// IMP=0x000000010000f284
