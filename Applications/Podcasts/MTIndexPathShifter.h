...
- (void).cxx_destruct;	// IMP=0x000000010014da68
- (void)_setIndexPath:(unsigned long long)arg1;	// IMP=0x000000010014d920
- (void)_shiftIndexPath:(unsigned long long)arg1;	// IMP=0x000000010014d8bc
- (void)processChangeAtIndexPath:(id)arg1 forChangeType:(unsigned long long)arg2 newIndexPath:(id)arg3;	// IMP=0x000000010014d650
