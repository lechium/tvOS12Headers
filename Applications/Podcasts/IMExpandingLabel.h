...
- (void).cxx_destruct;	// IMP=0x000000010020bda0
@property(nonatomic, getter=isScrollEnabled) _Bool scrollEnabled;
- (double)heightForWidth:(double)arg1;	// IMP=0x000000010020bb6c
- (void)moreButtonTapped:(id)arg1;	// IMP=0x000000010020b6ec
- (void)layoutSubviews;	// IMP=0x000000010020aa04
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010020a5f4
- (id)_font;	// IMP=0x000000010016ae6c
- (unsigned long long)maximumNumberOfLinesThatFitHeight:(double)arg1;	// IMP=0x000000010016ae10
- (void)setMoreButtonFont:(id)arg1;	// IMP=0x000000010016acf4
- (void)setFont:(id)arg1;	// IMP=0x000000010016abd8
