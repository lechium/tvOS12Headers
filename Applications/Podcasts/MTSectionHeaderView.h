...
+ (id)font;	// IMP=0x00000001001bf7c8
+ (double)height;	// IMP=0x00000001001bf71c
...
- (void).cxx_destruct;	// IMP=0x00000001001c05cc
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001001c047c
- (void)layoutSubviews;	// IMP=0x00000001001bffc0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001001bfef0
@property(retain, nonatomic) NSString *backdropGroupName;
- (void)_updateBlurEffects;	// IMP=0x00000001001bfb14
- (void)prepareForReuse;	// IMP=0x00000001001bfa80
- (void)_configureSubviews;	// IMP=0x00000001001bf864
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001001bf7e8
