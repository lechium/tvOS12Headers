...
+ (id)deleteAllContentInCtx:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100106140
+ (void)updateUPPMetadata:(id)arg1 fromUPPRecord:(id)arg2;	// IMP=0x0000000100106024
+ (id)createOrUpdateUPPMetadataFromUPPRecord:(id)arg1 inCtx:(id)arg2;	// IMP=0x0000000100105f24
+ (id)createOrUpdateUPPMetadataFromUPPMediaItem:(id)arg1 inCtx:(id)arg2;	// IMP=0x0000000100105e6c
