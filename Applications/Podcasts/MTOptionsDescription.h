...
+ (id)optionsWithLongTitles:(id)arg1 shortTitles:(id)arg2 valueList:(id)arg3;	// IMP=0x000000010012ddec
+ (id)optionsWithLongTitles:(id)arg1 shortTitles:(id)arg2 valueList:(id)arg3 footerTextCallback:(CDUnknownBlockType)arg4 headerTextCallback:(CDUnknownBlockType)arg5;	// IMP=0x000000010012dcb8
...
- (void).cxx_destruct;	// IMP=0x000000010012dfc0
- (unsigned long long)valueForIndex:(unsigned long long)arg1;	// IMP=0x000000010012dedc
- (unsigned long long)indexForValue:(unsigned long long)arg1;	// IMP=0x000000010012de74
