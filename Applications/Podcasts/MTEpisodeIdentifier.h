...
+ (id)identifierWithPlayerItem:(id)arg1;	// IMP=0x0000000100027af0
+ (id)identifierWithEpisode:(id)arg1;	// IMP=0x0000000100027a80
...
- (void).cxx_destruct;	// IMP=0x0000000100028328
- (_Bool)_hasFeedURL:(id)arg1;	// IMP=0x0000000100028170
- (void)_updateWithPodcast:(id)arg1;	// IMP=0x0000000100028010
- (id)initWithPlayerItem:(id)arg1;	// IMP=0x0000000100027d5c
- (id)initWithEpisode:(id)arg1;	// IMP=0x0000000100027b60
