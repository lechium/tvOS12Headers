...
+ (id)playlistWithMPPlaylist:(id)arg1;	// IMP=0x00000001000b5b08
...
- (void).cxx_destruct;	// IMP=0x00000001000b626c
- (id)description;	// IMP=0x00000001000b6054
- (_Bool)isEmpty;	// IMP=0x00000001000b5e90
- (id)children;	// IMP=0x00000001000b5e80
- (void)addChild:(id)arg1;	// IMP=0x00000001000b5dfc
