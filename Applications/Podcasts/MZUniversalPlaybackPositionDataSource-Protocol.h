...
- (void)commitUniversalPlaybackPositionTransaction:(id <MZUniversalPlaybackPositionTransactionContext>)arg1 domainVersion:(NSString *)arg2 metadataEnumerationBlock:(IMUniversalPlaybackPositionMetadata * (^)(void))arg3;
