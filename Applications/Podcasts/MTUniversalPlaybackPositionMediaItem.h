...
- (void).cxx_destruct;	// IMP=0x00000001000991e8
@property(readonly, copy) NSString *description;
- (void)populateEpisodeDictionary;	// IMP=0x0000000100098ac8
- (void)enumerateValuesForProperties:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100098908
