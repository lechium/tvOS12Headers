...
+ (void)loadBagContextFromIMURLBag:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100066580
+ (double)defaultPollingInterval;	// IMP=0x0000000100066410
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000664a0
- (void)dealloc;	// IMP=0x000000010006641c
