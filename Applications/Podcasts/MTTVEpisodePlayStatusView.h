...
- (void).cxx_destruct;	// IMP=0x0000000100194de8
- (void)didMoveToWindow;	// IMP=0x0000000100194bec
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100194be0
- (void)layoutSubviews;	// IMP=0x0000000100194a2c
- (void)updatePlaybackState;	// IMP=0x0000000100194890
- (void)_unregisterForNotifications;	// IMP=0x00000001001947a0
- (void)_registerForNotifications;	// IMP=0x000000010019469c
@property(nonatomic) unsigned long long barsStyle;
@property(nonatomic) UIImage *image;
- (void)dealloc;	// IMP=0x0000000100194114
- (id)init;	// IMP=0x0000000100194094
