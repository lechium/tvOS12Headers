...
+ (_Bool)isMediaItemSyncedFromiTunes:(id)arg1;	// IMP=0x00000001000bc220
+ (id)propertiesForMediaItem;	// IMP=0x00000001000bc050
+ (_Bool)isMissingAssetForItem:(id)arg1;	// IMP=0x00000001000bbed4
+ (_Bool)isMissingFilePathForItem:(id)arg1;	// IMP=0x00000001000bbe70
+ (id)itemWithMPMediaItem:(id)arg1 isRestoreDownloadCandidate:(_Bool)arg2;	// IMP=0x00000001000bb644
+ (id)itemWithMPMediaItem:(id)arg1;	// IMP=0x00000001000bb634
...
- (void).cxx_destruct;	// IMP=0x00000001000bc5d4
- (id)description;	// IMP=0x00000001000bbf84
