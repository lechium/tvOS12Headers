...
- (void).cxx_destruct;	// IMP=0x000000010003b168
- (void)addUuid:(id)arg1 changeType:(int)arg2;	// IMP=0x000000010003afb4
- (void)combineChanges:(id)arg1;	// IMP=0x000000010003aea8
- (_Bool)hasUpdates;	// IMP=0x000000010003ae58
- (_Bool)hasDeletes;	// IMP=0x000000010003ae08
- (_Bool)hasInserts;	// IMP=0x000000010003adb8
- (_Bool)hasChanges;	// IMP=0x000000010003ad5c
- (id)description;	// IMP=0x000000010003aca8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003ab20
- (id)initWithEntityName:(id)arg1;	// IMP=0x000000010003aa10
