...
- (void).cxx_destruct;	// IMP=0x000000010015c274
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010015c14c
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x000000010015bf94
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010015bf90
- (id)_extraObjects;	// IMP=0x000000010015be64
- (id)allObjects;	// IMP=0x000000010015bdc0
- (void)_initializeFrc;	// IMP=0x000000010015bd10
