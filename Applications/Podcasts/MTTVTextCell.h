...
- (void).cxx_destruct;	// IMP=0x00000001000b4778
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x00000001000b462c
- (void)showEditTitleUI;	// IMP=0x00000001000b44ec
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000001000b43f8
