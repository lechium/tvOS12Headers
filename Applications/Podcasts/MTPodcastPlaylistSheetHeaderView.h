...
- (void).cxx_destruct;	// IMP=0x00000001000ed2cc
- (void)buttonTapped:(id)arg1;	// IMP=0x00000001000ed1d0
- (void)layoutSubviews;	// IMP=0x00000001000ece9c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000ecb70
