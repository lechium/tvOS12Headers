...
+ (id)messageLabelWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100038ffc
...
- (void).cxx_destruct;	// IMP=0x000000010003a2ac
- (void)_sizeCategoryDidChange:(id)arg1;	// IMP=0x000000010003a0f0
- (void)_buttonClick;	// IMP=0x000000010003a074
- (void)layoutSubviews;	// IMP=0x0000000100039c9c
- (void)dealloc;	// IMP=0x0000000100039398
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 message:(id)arg3;	// IMP=0x00000001000391a0
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2;	// IMP=0x0000000100039190
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100039180
