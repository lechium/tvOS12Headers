...
- (void).cxx_destruct;	// IMP=0x000000010004b5a0
- (void)runQueryInContext:(id)arg1;	// IMP=0x000000010004b08c
- (void)runQuery;	// IMP=0x000000010004b010
- (void)runQueryWithPodcastPredicate:(id)arg1 episodePredicate:(id)arg2;	// IMP=0x000000010004af88
- (id)init;	// IMP=0x000000010004af14
