...
+ (id)requestForUrl:(id)arg1 key:(id)arg2 podcastUuid:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010001af88
...
- (void).cxx_destruct;	// IMP=0x000000010001b3d4
- (id)description;	// IMP=0x000000010001b1dc
- (id)initWithUrl:(id)arg1 key:(id)arg2 podcastUuid:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010001b048
