...
- (void)_clearCachedValues;	// IMP=0x000000010008c830
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010008c760
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x000000010008c620
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x000000010008c5d0
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x000000010008c580
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x000000010008c530
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x000000010008c4e0
- (void)setFont:(id)arg1;	// IMP=0x000000010008c490
- (void)setText:(id)arg1;	// IMP=0x000000010008c440
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010008c378
