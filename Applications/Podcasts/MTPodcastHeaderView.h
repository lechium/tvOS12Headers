...
- (void)expandingLabelShouldExpand:(id)arg1;	// IMP=0x0000000100042b10
- (id)stringForEpisodesLabel;	// IMP=0x0000000100042b08
- (id)stringForUpdatedLabel:(id)arg1;	// IMP=0x0000000100042b00
- (void)_setupView;	// IMP=0x0000000100042288
- (void)setMoreButtonFont:(id)arg1;	// IMP=0x0000000100042190
- (void)_updateFonts;	// IMP=0x0000000100041fac
- (void)didMoveToSuperview;	// IMP=0x0000000100041520
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000413f4
- (void)layoutSubviews;	// IMP=0x00000001000406e0
- (id)creatSeperatorView;	// IMP=0x0000000100040394
- (void)setUserInteractionEnabled:(_Bool)arg1;	// IMP=0x0000000100040348
- (void)setAlpha:(double)arg1;	// IMP=0x00000001000402f0
- (void)setEnabled:(_Bool)arg1;	// IMP=0x00000001000402a4
- (void)updateImageSize;	// IMP=0x000000010003ff68
- (void)updateImageSizeIfNeeded;	// IMP=0x000000010003ff48
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010003fdac
- (void)contentSizeCategoryDidChange:(id)arg1;	// IMP=0x000000010003fda0
- (void)shareTapped:(id)arg1;	// IMP=0x000000010003fce8
- (void)dealloc;	// IMP=0x000000010003fc30
- (id)initWithImage:(id)arg1 podcastUuid:(id)arg2 frame:(struct CGRect)arg3 forcePhoneStyle:(_Bool)arg4;	// IMP=0x000000010003faf4
- (id)initWithPodcastUUID:(id)arg1;	// IMP=0x000000010003fa48
- (_Bool)usePad;	// IMP=0x000000010003fa10
