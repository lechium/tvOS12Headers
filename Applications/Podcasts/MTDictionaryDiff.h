...
- (void).cxx_destruct;	// IMP=0x00000001001348b0
- (void)addCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000001001347d0
- (id)initWithProperties:(id)arg1;	// IMP=0x0000000100134468
- (id)init;	// IMP=0x0000000100134458
