...
- (void).cxx_destruct;	// IMP=0x00000001000a3bc4
- (void)layoutSubviews;	// IMP=0x00000001000a3714
- (void)_updateGradientColors;	// IMP=0x00000001000a35a8
- (id)_blurredImageForImage:(id)arg1;	// IMP=0x00000001000a350c
- (id)initWithArtwork:(id)arg1 blendColor:(id)arg2;	// IMP=0x00000001000a313c
- (id)init;	// IMP=0x00000001000a3128
