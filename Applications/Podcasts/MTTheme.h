...
+ (id)insertNewTheme:(id)arg1 forUuid:(id)arg2 inMOC:(id)arg3;	// IMP=0x000000010003c188
+ (_Bool)createOrUpdateTheme:(id)arg1 forUuid:(id)arg2 inMOC:(id)arg3;	// IMP=0x000000010003c068
- (void)populateWithColorTheme:(id)arg1;	// IMP=0x000000010003c338
- (id)convertToColorTheme;	// IMP=0x000000010003c22c
