...
- (void).cxx_destruct;	// IMP=0x00000001001f2280
- (id)description;	// IMP=0x00000001001f1f7c
@property(readonly, nonatomic) UIImage *artwork;
- (unsigned long long)hash;	// IMP=0x00000001001f1a9c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001f17cc
