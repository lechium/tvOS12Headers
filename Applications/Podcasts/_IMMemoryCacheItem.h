...
+ (id)cacheItemWithItem:(id)arg1 key:(id)arg2 cost:(unsigned long long)arg3;	// IMP=0x00000001001cc874
...
- (id)description;	// IMP=0x00000001001cc9c4
- (void)dealloc;	// IMP=0x00000001001cc960
