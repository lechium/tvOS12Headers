...
- (id)description;	// IMP=0x00000001000583f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100058340
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005818c
- (unsigned long long)hash;	// IMP=0x00000001000580f8
