...
- (void).cxx_destruct;	// IMP=0x00000001001a3f44
- (id)metricsContentIdentifier;	// IMP=0x00000001001a3cf4
- (id)metricsName;	// IMP=0x00000001001a3cc8
- (void)descriptionViewTapped:(id)arg1;	// IMP=0x00000001001a3c20
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000001001a3c18
- (void)update;	// IMP=0x00000001001a3a44
- (void)_updateFonts;	// IMP=0x00000001001a3878
- (void)contentSizeCategoryDidChange:(id)arg1;	// IMP=0x00000001001a3834
- (void)layoutSubviews;	// IMP=0x00000001001a33f0
- (void)addSubviews;	// IMP=0x00000001001a2e58
- (void)dealloc;	// IMP=0x00000001001a2de0
- (id)initWithPodcastUuid:(id)arg1;	// IMP=0x00000001001a2cb0
