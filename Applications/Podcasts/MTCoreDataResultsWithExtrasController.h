...
- (void).cxx_destruct;	// IMP=0x00000001001642d8
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x0000000100164134
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x0000000100163f78
- (_Bool)_hasResults;	// IMP=0x0000000100163ef0
- (id)_extraObjects;	// IMP=0x0000000100163e28
- (id)allObjects;	// IMP=0x0000000100163d58
- (void)_initializeFrc;	// IMP=0x0000000100163cac
