...
+ (double)rightViewControllerTopMargin;	// IMP=0x00000001000ebd70
...
- (void).cxx_destruct;	// IMP=0x00000001000ebff8
- (void)_updateTitle;	// IMP=0x00000001000ebd7c
- (void)viewDidLoad;	// IMP=0x00000001000eba28
- (id)initWithPodcast:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000eb964
- (id)initWithPodcast:(id)arg1;	// IMP=0x00000001000eb954
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000eb944
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000eb934
