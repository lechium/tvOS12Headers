...
- (void)_handleMenuPress:(id)arg1;	// IMP=0x0000000100006128
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000001000060b8
- (void)viewDidLoad;	// IMP=0x0000000100005a90
- (id)initWithLoadingStep:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100005724
