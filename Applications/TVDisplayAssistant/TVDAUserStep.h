...
- (void).cxx_destruct;	// IMP=0x0000000100003e24
@property(readonly, copy) NSString *debugDescription;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100003920
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000036c4
- (void)runMeasurement:(CDUnknownBlockType)arg1;	// IMP=0x00000001000036bc
- (void)addAction:(id)arg1;	// IMP=0x000000010000363c
@property(readonly, copy, nonatomic) NSArray *actions;
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 footer:(id)arg3 appleSupportFooter:(id)arg4;	// IMP=0x00000001000034b4
