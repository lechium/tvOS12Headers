...
+ (id)_dataItemForParameters:(id)arg1;	// IMP=0x0000000100004c80
...
- (void)mergePropertiesFromDataItem:(id)arg1 toDataItem:(id)arg2;	// IMP=0x00000001000053a4
- (void)loadStreamingKeyForRequest:(id)arg1;	// IMP=0x000000010000533c
- (_Bool)hasTrait:(id)arg1;	// IMP=0x0000000100005238
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000100004b68
