...
- (void).cxx_destruct;	// IMP=0x0000000100017c04
- (void)_menuPressed;	// IMP=0x0000000100017b48
- (void)setTitle:(id)arg1;	// IMP=0x0000000100017950
- (void)viewDidLoad;	// IMP=0x00000001000173ac
