...
- (void).cxx_destruct;	// IMP=0x0000000100027f48
...
- (id)initWithVideoCredits:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000100027c00
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100027b78
- (id)init;	// IMP=0x0000000100027af0
