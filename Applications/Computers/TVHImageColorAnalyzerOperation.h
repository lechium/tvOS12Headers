...
- (void).cxx_destruct;	// IMP=0x000000010000f6a8
- (void)cancel;	// IMP=0x000000010000f548
- (void)executionDidBegin;	// IMP=0x000000010000f1a4
- (id)initWithMediaEntity:(id)arg1;	// IMP=0x000000010000f0ec
- (id)init;	// IMP=0x000000010000f064
