...
+ (_Bool)allowsReverseTransformation;	// IMP=0x000000010002c884
+ (Class)transformedValueClass;	// IMP=0x000000010002c870
@property(nonatomic) unsigned long long verbType; // @synthesize verbType=_verbType;
- (id)transformedValue:(id)arg1;	// IMP=0x000000010002c88c
- (id)init;	// IMP=0x000000010002c82c
