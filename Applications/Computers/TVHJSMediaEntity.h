...
- (void).cxx_destruct;	// IMP=0x00000001000293e4
- (id)imageResourceNameWithSize:(id)arg1;	// IMP=0x000000010002921c
...
- (id)initWithMediaEntity:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000100028614
- (id)initWithAppContext:(id)arg1;	// IMP=0x000000010002858c
- (id)init;	// IMP=0x0000000100028504
