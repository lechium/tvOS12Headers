...
- (void).cxx_destruct;	// IMP=0x000000010000d43c
@property(readonly, nonatomic) unsigned long long count;
@property(readonly, nonatomic) unsigned long long startIndex;
@property(readonly, copy, nonatomic) NSString *title;
@property(readonly, copy) NSString *description;
- (id)initWithMediaEntitySortHeader:(id)arg1 appContext:(id)arg2;	// IMP=0x000000010000d12c
- (id)initWithAppContext:(id)arg1;	// IMP=0x000000010000d0a4
- (id)init;	// IMP=0x000000010000d01c
