...
+ (id)_pieImageAtFraction:(double)arg1;	// IMP=0x0000000100043338
...
- (id)_maskImage;	// IMP=0x0000000100043c30
- (void)_drawPauseUIWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000100043a50
- (void)_drawIncomingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000100043954
- (void)_drawOutgoingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000100043768
- (void)_drawPieWithCenter:(struct CGPoint)arg1;	// IMP=0x00000001000436c0
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000100043130
- (void)_clearDisplayLink;	// IMP=0x00000001000430f4
- (void)_ensureDisplayLink;	// IMP=0x0000000100043018
- (void)_onDisplayLink:(id)arg1;	// IMP=0x0000000100042ee8
- (void)_updateFractionTransitionAnimated:(_Bool)arg1;	// IMP=0x0000000100042de0
- (void)_updateStateTransitionAnimated:(_Bool)arg1;	// IMP=0x0000000100042cbc
- (void)_updatePausedTransitionAnimated:(_Bool)arg1;	// IMP=0x0000000100042c1c
- (void)_updateTransitionsAnimated:(_Bool)arg1;	// IMP=0x00000001000429dc
- (_Bool)_hasActiveTransitions;	// IMP=0x000000010004299c
- (void)setState:(long long)arg1 paused:(_Bool)arg2 fractionLoaded:(double)arg3 animated:(_Bool)arg4;	// IMP=0x0000000100042890
- (void)dealloc;	// IMP=0x0000000100042838
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000427b8
