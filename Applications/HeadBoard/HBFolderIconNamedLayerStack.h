...
+ (id)_flatFolderImageWithForegroundImage:(id)arg1 interfaceStyle:(long long)arg2;	// IMP=0x00000001000a1b10
- (void).cxx_destruct;	// IMP=0x00000001000a1d3c
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) double scale;
@property(readonly, nonatomic) struct CGSize size;
@property(readonly, nonatomic) struct CGImage *flattenedImage;
@property(readonly, nonatomic) NSArray *layers;
- (id)initWithFolder:(id)arg1;	// IMP=0x00000001000a1744
