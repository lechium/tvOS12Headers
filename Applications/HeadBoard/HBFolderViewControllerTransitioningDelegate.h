...
- (void).cxx_destruct;	// IMP=0x0000000100040028
- (void)_cleanup;	// IMP=0x000000010003ff2c
- (_Bool)_isItemTransition;	// IMP=0x000000010003fef0
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x000000010003fc14
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x000000010003f8c4
