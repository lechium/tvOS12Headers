...
- (void).cxx_destruct;	// IMP=0x0000000100013670
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100013598
- (void)_setFocusDirection:(struct CGPoint)arg1;	// IMP=0x00000001000134ec
