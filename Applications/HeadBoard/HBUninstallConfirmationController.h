...
- (void).cxx_destruct;	// IMP=0x0000000100012ac4
- (void)_generateUninstallConfirmation;	// IMP=0x0000000100011f8c
- (void)_completeUninstallWillRemove:(_Bool)arg1;	// IMP=0x0000000100011ef0
- (void)cancel;	// IMP=0x0000000100011e90
- (void)startWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000119f4
@property(readonly, nonatomic) _Bool finishedApplicationRemovalConfirmation;
- (id)initWithApplication:(id)arg1 parentViewController:(id)arg2;	// IMP=0x00000001000118d0
