...
- (void).cxx_destruct;	// IMP=0x0000000100063708
- (void)_exitIdleMode;	// IMP=0x00000001000634a4
- (void)_enterIdleMode;	// IMP=0x00000001000630bc
- (void)_updateWithCurrentUserInterfaceStyle;	// IMP=0x0000000100062fa8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100062ef0
- (void)dealloc;	// IMP=0x0000000100062e14
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100062cbc
