...
- (void).cxx_destruct;	// IMP=0x0000000100052280
- (void)_updateWithCurrentStyle;	// IMP=0x0000000100051ed8
- (void)_updateImageViews;	// IMP=0x0000000100051bc4
@property(readonly, nonatomic) struct CGSize imageSize;
- (void)layoutSubviews;	// IMP=0x000000010005163c
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0000000100051484
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005141c
