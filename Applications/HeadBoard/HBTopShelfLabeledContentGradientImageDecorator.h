...
- (void).cxx_destruct;	// IMP=0x0000000100008224
- (id)decoratorIdentifier;	// IMP=0x0000000100008178
- (struct CGSize)expectedSize;	// IMP=0x000000010000816c
- (id)decorate:(id)arg1 scaledWithSize:(struct CGSize)arg2 croppedToFit:(_Bool)arg3;	// IMP=0x0000000100007b90
