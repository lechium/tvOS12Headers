...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100008554
...
- (void).cxx_destruct;	// IMP=0x000000010000859c
- (id)description;	// IMP=0x0000000100008478
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000083ec
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000082f8
