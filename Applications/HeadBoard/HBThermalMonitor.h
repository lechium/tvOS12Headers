...
+ (id)sharedThermalMonitor;	// IMP=0x000000010002e384
...
- (void)_updateThermalShutdownState;	// IMP=0x000000010002e5e4
- (void)dealloc;	// IMP=0x000000010002e584
- (id)init;	// IMP=0x000000010002e404
