...
- (void).cxx_destruct;	// IMP=0x0000000100016aa4
- (void)_launchAppForSettingItem:(id)arg1;	// IMP=0x00000001000168b8
- (void)_didSelectSettingItem:(id)arg1;	// IMP=0x0000000100016800
- (id)_photoCollectionGroups;	// IMP=0x0000000100016778
- (id)_localizedTitleForPhotoCollectionGroup:(id)arg1;	// IMP=0x0000000100016768
- (void)controller:(id)arg1 didSelectAsset:(id)arg2 inCollection:(id)arg3;	// IMP=0x0000000100016674
- (id)loadSettingGroups;	// IMP=0x00000001000161d4
- (id)title;	// IMP=0x0000000100016164
