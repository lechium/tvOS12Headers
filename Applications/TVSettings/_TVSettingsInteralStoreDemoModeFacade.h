...
- (void).cxx_destruct;	// IMP=0x000000010003f970
...
- (_Bool)applyChanges;	// IMP=0x000000010003f3e4
@property(readonly, getter=isDirty) _Bool dirty;
- (unsigned long long)modeTypeEnum;	// IMP=0x000000010003f0d4
- (unsigned long long)modeTypeIndexToEnum:(long long)arg1;	// IMP=0x000000010003f0c0
- (id)availableModeTypes;	// IMP=0x000000010003f040
@property(nonatomic, getter=isEnabled) _Bool enabled;
@property(readonly, nonatomic, getter=isEnrolledInDeKOTA) _Bool enrolledInDeKOTA;
- (void)restoreDefaults;	// IMP=0x000000010003ecf8
- (id)init;	// IMP=0x000000010003eca0
