...
- (void).cxx_destruct;	// IMP=0x000000010000b66c
- (void)_checkForPreloadCompletion;	// IMP=0x000000010000b4a0
- (void)_imageProxyDidFail:(id)arg1 withError:(id)arg2;	// IMP=0x000000010000b384
- (void)_imageProxyDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x000000010000b298
- (void)_loadPendingImages;	// IMP=0x000000010000ae94
- (id)_imageProxyToLoadNext;	// IMP=0x000000010000adb8
- (void)_fillQueue;	// IMP=0x000000010000ac88
- (long long)_currentQueueSize;	// IMP=0x000000010000ac14
- (id)popNextImage;	// IMP=0x000000010000ab58
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000aaec
- (void)dealloc;	// IMP=0x000000010000a9b0
- (id)init;	// IMP=0x000000010000a898
