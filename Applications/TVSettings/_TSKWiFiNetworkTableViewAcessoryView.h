...
@interface _TSKWiFiNetworkTableViewAcessoryView : UIView
{
...
- (void)setTintColor:(id)arg1;	// IMP=0x000000010004ace8
- (void)layoutSubviews;	// IMP=0x000000010004a93c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010004a870
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010004a5b0
