...
- (void).cxx_destruct;	// IMP=0x00000001000abb9c
- (unsigned long long)_viewTypeForNumberOfImages:(long long)arg1;	// IMP=0x00000001000aba50
- (unsigned long long)_paradeThreshold;	// IMP=0x00000001000aba30
- (void)_displayPlaceholderView;	// IMP=0x00000001000ab72c
- (void)_fadeToBlack;	// IMP=0x00000001000ab624
- (void)_dissolveToPendingView;	// IMP=0x00000001000ab1e8
- (void)setInOrder:(_Bool)arg1;	// IMP=0x00000001000ab0ec
- (void)setShuffled:(_Bool)arg1;	// IMP=0x00000001000aaff4
- (void)resume;	// IMP=0x00000001000aaf84
- (_Bool)isPaused;	// IMP=0x00000001000aaf04
- (void)pause;	// IMP=0x00000001000aae94
- (void)_scrollingParadeViewReadyNotification:(id)arg1;	// IMP=0x00000001000aaad4
- (void)_paradeViewReadyNotification:(id)arg1;	// IMP=0x00000001000aa9fc
- (void)_legacyCrossfadeViewReadyNotification:(id)arg1;	// IMP=0x00000001000aa928
- (void)_crossfadeViewReadyNotification:(id)arg1;	// IMP=0x00000001000aa854
- (void)layoutSubviews;	// IMP=0x00000001000aa7c8
- (void)dealloc;	// IMP=0x00000001000aa72c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000aa51c
