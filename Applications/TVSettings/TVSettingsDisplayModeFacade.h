...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x000000010008adb8
+ (id)sharedInstance;	// IMP=0x0000000100087648
...
- (void).cxx_destruct;	// IMP=0x000000010008b18c
- (void)displayState:(id)arg1 didChangeWithConnection:(long long)arg2;	// IMP=0x000000010008ab3c
- (void)_reloadDataFromCache;	// IMP=0x000000010008a8a8
- (id)_sortedDisplayModesForUserPresentation:(id)arg1;	// IMP=0x0000000100089d8c
- (void)presentCableCheckDisplayAssistant;	// IMP=0x0000000100089d0c
- (void)presentUpgradeAttemptDisplayAssistant;	// IMP=0x0000000100089c78
- (void)resetVideoSettingsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100089b50
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100089ae0
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 requestConfiguration:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000898d4
- (void)_enumerateValidColorModesFromSortedModes:(id)arg1 existingFiltering:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010008927c
@property(readonly, nonatomic) TVSettingsDisplayAssistantActionInfo *displayAssistantActionInfo;
- (_Bool)shouldShowDisplayAssistant;	// IMP=0x0000000100088f54
...
- (id)_recalculatedUnverifiedModes;	// IMP=0x00000001000880b0
- (id)_recalculatedUserVisibleHDRChromaModes;	// IMP=0x0000000100087ebc
- (id)_recalculatedUserVisibleSDRChromaModes;	// IMP=0x0000000100087cb8
- (id)_recalculatedUserVisibleSDRColorMappingModes;	// IMP=0x0000000100087944
- (void)dealloc;	// IMP=0x00000001000878bc
