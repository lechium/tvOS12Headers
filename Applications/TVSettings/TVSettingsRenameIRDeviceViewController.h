...
- (void).cxx_destruct;	// IMP=0x000000010004bad4
- (void)editingController:(id)arg1 didCancelForSettingItem:(id)arg2;	// IMP=0x000000010004ba24
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x000000010004b7e0
- (void)viewDidLoad;	// IMP=0x000000010004b540
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010004b4b8
