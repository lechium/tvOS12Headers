...
+ (id)keyPathsForValuesAffectingScreenSaverName;	// IMP=0x0000000100097d3c
+ (id)sharedInstance;	// IMP=0x00000001000978cc
- (void).cxx_destruct;	// IMP=0x000000010009a094
- (void)_fetchPhotoCollections;	// IMP=0x0000000100099ea4
- (void)_openApplicationWithIdentifer:(id)arg1;	// IMP=0x0000000100099c50
- (void)_photoSourcesUpdated:(id)arg1;	// IMP=0x0000000100099c44
- (void)launchPhotoSourcesDaemon;	// IMP=0x0000000100099c38
- (void)killPhotoSourcesDaemon;	// IMP=0x0000000100099c0c
- (void)disableScreenSaverProviders;	// IMP=0x000000010009992c
- (void)resetToIdleScreensaver;	// IMP=0x00000001000998e0
...
- (void)dealloc;	// IMP=0x0000000100097cc4
- (id)init;	// IMP=0x00000001000979d4
