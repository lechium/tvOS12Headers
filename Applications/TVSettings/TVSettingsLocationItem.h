...
+ (id)_imageForInfo:(id)arg1;	// IMP=0x0000000100075dc4
+ (id)_allowedAccessTypesForInfo:(id)arg1;	// IMP=0x0000000100075c5c
+ (unsigned long long)_accessTypeForInfo:(id)arg1;	// IMP=0x0000000100075c1c
+ (unsigned long long)_itemTypeForInfo:(id)arg1;	// IMP=0x0000000100075bd4
+ (id)_explanatoryTextForInfo:(id)arg1;	// IMP=0x0000000100075a50
+ (id)_titleForIdentifier:(id)arg1 info:(id)arg2;	// IMP=0x00000001000757b4
...
- (id)initWithInfo:(id)arg1 identifier:(id)arg2;	// IMP=0x00000001000752d0
- (id)init;	// IMP=0x00000001000752bc
