...
- (void).cxx_destruct;	// IMP=0x000000010003738c
- (id)description;	// IMP=0x00000001000371fc
- (id)init;	// IMP=0x00000001000371e4
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x0000000100037104
