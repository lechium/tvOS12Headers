...
- (void).cxx_destruct;	// IMP=0x00000001000cce88
- (_Bool)hasPurchasedMoreStorage;	// IMP=0x00000001000cce14
- (id)storageFooter:(_Bool)arg1;	// IMP=0x00000001000cce0c
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x00000001000cc688
