...
- (void).cxx_destruct;	// IMP=0x0000000100037eb0
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x0000000100037ba8
- (void)_loadNextImage:(id)arg1;	// IMP=0x0000000100037b00
- (void)_startTimer;	// IMP=0x0000000100037a48
- (void)layoutSubviews;	// IMP=0x0000000100037594
- (void)didMoveToSuperview;	// IMP=0x000000010003752c
- (void)dealloc;	// IMP=0x00000001000374d4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000373cc
