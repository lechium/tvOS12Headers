...
+ (id)sharedTransitionTester;	// IMP=0x000000010004c3e0
...
- (void).cxx_destruct;	// IMP=0x000000010004ca4c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010004c6a0
- (void)startPopTransition;	// IMP=0x000000010004c638
- (void)startPushTransition;	// IMP=0x000000010004c4f4
- (void)runTest;	// IMP=0x000000010004c42c
