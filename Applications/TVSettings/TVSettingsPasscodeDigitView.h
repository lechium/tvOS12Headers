...
- (void).cxx_destruct;	// IMP=0x00000001000b4550
- (id)hiddenDigitImage;	// IMP=0x00000001000b40e0
- (id)arrowImage:(_Bool)arg1;	// IMP=0x00000001000b3ed0
- (void)downGesture:(id)arg1;	// IMP=0x00000001000b3da8
- (void)upGesture:(id)arg1;	// IMP=0x00000001000b3c94
@property(copy, nonatomic) NSString *text;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000b39f0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000b38b0
- (_Bool)canBecomeFocused;	// IMP=0x00000001000b38a8
- (void)layoutSubviews;	// IMP=0x00000001000b3608
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b2eb4
