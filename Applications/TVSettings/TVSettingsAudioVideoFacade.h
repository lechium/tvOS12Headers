...
+ (id)sharedInstance;	// IMP=0x0000000100030af4
...
- (void).cxx_destruct;	// IMP=0x00000001000320c0
- (id)_availableDefaultAudioLanguages;	// IMP=0x0000000100031ea0
- (id)_availableDefaultSubtitleLanguages;	// IMP=0x0000000100031ca4
- (void)_updateSelectedSubtitleOption:(_Bool)arg1;	// IMP=0x0000000100031b64
- (void)_updateAvailableSubtitleLanguageOptions:(_Bool)arg1;	// IMP=0x00000001000319ac
- (void)_updateAvailableAudioLanguageCodes:(_Bool)arg1;	// IMP=0x0000000100031798
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003148c
@property(nonatomic) _Bool atmosEnabled;
...
- (void)dealloc;	// IMP=0x0000000100030c98
- (id)init;	// IMP=0x0000000100030b74
