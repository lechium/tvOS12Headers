...
- (void).cxx_destruct;	// IMP=0x00000001000851d4
- (void)_fetchAppUsageInfo;	// IMP=0x0000000100084d1c
- (void)uninstallAppWithProxy:(id)arg1;	// IMP=0x0000000100084b38
- (void)dealloc;	// IMP=0x0000000100084a5c
- (id)init;	// IMP=0x00000001000848f4
