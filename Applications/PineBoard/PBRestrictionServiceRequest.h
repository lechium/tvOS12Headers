...
- (id)description;	// IMP=0x00000001000060c4
- (unsigned long long)hash;	// IMP=0x000000010000609c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100005f7c
- (id)initWithToken:(id)arg1 requestType:(unsigned long long)arg2;	// IMP=0x0000000100005eec
- (id)initWithToken:(id)arg1;	// IMP=0x0000000100005ecc
