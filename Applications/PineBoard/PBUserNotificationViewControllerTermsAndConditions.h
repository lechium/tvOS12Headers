...
- (void).cxx_destruct;	// IMP=0x00000001000f5344
- (void)_handleHomeButton;	// IMP=0x00000001000f5184
- (void)_handleMenuButton;	// IMP=0x00000001000f5088
- (void)viewDidLoad;	// IMP=0x00000001000f454c
- (id)initWithTitle:(id)arg1 text:(id)arg2;	// IMP=0x00000001000f44c4
