...
- (void).cxx_destruct;	// IMP=0x000000010005e05c
- (void)cancel;	// IMP=0x000000010005dff8
- (void)main;	// IMP=0x000000010005dd04
- (id)initWithGenerationBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010005dc6c
