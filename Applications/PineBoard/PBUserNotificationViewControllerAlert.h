...
- (void).cxx_destruct;	// IMP=0x0000000100101698
- (void)_didSelectButtonAtIndex:(unsigned long long)arg1;	// IMP=0x00000001001015e8
- (void)updateWithNotification:(id)arg1;	// IMP=0x0000000100100c08
- (void)_handleHomeButton;	// IMP=0x0000000100100918
- (void)_handleMenuButton;	// IMP=0x000000010010081c
- (void)viewDidLoad;	// IMP=0x00000001001005d4
- (id)init;	// IMP=0x0000000100100578
