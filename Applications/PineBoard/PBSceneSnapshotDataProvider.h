...
- (void).cxx_destruct;	// IMP=0x0000000100083994
- (void)invalidateImage;	// IMP=0x00000001000838f8
- (id)fetchImage;	// IMP=0x000000010008350c
- (id)initWithSceneSnapshot:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x000000010008335c
- (id)init;	// IMP=0x0000000100083344
