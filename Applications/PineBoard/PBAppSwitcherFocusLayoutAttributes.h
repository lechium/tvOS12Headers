...
- (id)description;	// IMP=0x0000000100076a9c
- (unsigned long long)hash;	// IMP=0x0000000100076848
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010007653c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010007636c
