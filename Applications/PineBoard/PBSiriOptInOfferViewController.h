...
- (void).cxx_destruct;	// IMP=0x00000001000b2630
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x00000001000b2278
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x00000001000b2244
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x00000001000b2210
- (void)_readAboutText:(id)arg1;	// IMP=0x00000001000b21f0
- (void)_dismissViewControllerWithValue:(_Bool)arg1;	// IMP=0x00000001000b20a4
- (void)_optOut:(id)arg1;	// IMP=0x00000001000b2084
- (void)_optIn:(id)arg1;	// IMP=0x00000001000b1fc0
- (void)_handleHomeButton:(id)arg1;	// IMP=0x00000001000b1ee4
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00000001000b1de8
- (id)preferredFocusEnvironments;	// IMP=0x00000001000b1d7c
- (void)viewDidLoad;	// IMP=0x00000001000b1678
- (void)dealloc;	// IMP=0x00000001000b15f0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000b1554
