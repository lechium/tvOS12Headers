...
- (void).cxx_destruct;	// IMP=0x0000000100032554
- (void)_presentVolumeBulletinForRouteWithName:(id)arg1 volumeLevel:(float)arg2;	// IMP=0x00000001000320e4
- (void)_updateVolume;	// IMP=0x000000010003179c
- (void)_setNeedsVolumeUpdate;	// IMP=0x00000001000316d8
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x0000000100031688
- (void)routingController:(id)arg1 pickedRoutesDidChange:(id)arg2;	// IMP=0x0000000100031580
- (void)volumeController:(id)arg1 volumeValueDidChange:(float)arg2;	// IMP=0x00000001000313ec
- (void)volumeController:(id)arg1 volumeControlAvailableDidChange:(_Bool)arg2;	// IMP=0x0000000100031260
- (void)setVolumeNotificationsEnabled:(_Bool)arg1 forOutputContext:(unsigned long long)arg2;	// IMP=0x0000000100031160
- (_Bool)volumeSupportedForOutputContext:(unsigned long long)arg1;	// IMP=0x000000010003113c
- (void)decreaseVolumeForOutputContext:(unsigned long long)arg1;	// IMP=0x0000000100030ff4
- (void)increaseVolumeForOutputContext:(unsigned long long)arg1;	// IMP=0x0000000100030e38
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000100030b14
- (id)init;	// IMP=0x0000000100030afc
