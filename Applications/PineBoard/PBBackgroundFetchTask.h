...
- (void).cxx_destruct;	// IMP=0x00000001000f61ac
- (void)finishWithResult:(unsigned long long)arg1;	// IMP=0x00000001000f5f5c
- (id)initForApplication:(id)arg1 sequenceNumber:(unsigned int)arg2;	// IMP=0x00000001000f5ac0
