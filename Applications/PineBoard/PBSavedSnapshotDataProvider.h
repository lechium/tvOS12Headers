...
- (void).cxx_destruct;	// IMP=0x00000001000cd814
- (void)invalidateImage;	// IMP=0x00000001000cd748
- (id)fetchImage;	// IMP=0x00000001000cd148
- (id)initWithSnapshotPredicate:(id)arg1 sceneID:(id)arg2 bundleIdentifier:(id)arg3 scaleFactor:(double)arg4;	// IMP=0x00000001000ccf9c
- (id)init;	// IMP=0x00000001000ccf84
