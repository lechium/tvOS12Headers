...
- (void).cxx_destruct;	// IMP=0x0000000100012f08
- (_Bool)isEqualToMetadata:(id)arg1;	// IMP=0x0000000100012de0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100012d54
- (unsigned long long)hash;	// IMP=0x0000000100012d3c
