...
+ (id)sharedInstance;	// IMP=0x0000000100004634
...
- (void).cxx_destruct;	// IMP=0x0000000100004f8c
- (void)operationFailed:(id)arg1;	// IMP=0x0000000100004e58
- (void)didReceiveProgress:(long long)arg1;	// IMP=0x0000000100004d28
- (void)didReceiveError:(id)arg1;	// IMP=0x0000000100004c80
- (void)blockingStateChanged:(_Bool)arg1;	// IMP=0x0000000100004bb4
- (id)errorMessageFromErrors;	// IMP=0x00000001000047cc
- (id)init;	// IMP=0x00000001000046b4
