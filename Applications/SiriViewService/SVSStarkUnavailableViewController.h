...
- (void).cxx_destruct;	// IMP=0x000000010002639c
- (_Bool)isActive;	// IMP=0x00000001000262c4
- (void)viewDidLoad;	// IMP=0x0000000100025fd0
- (void)loadView;	// IMP=0x0000000100025f1c
- (id)init;	// IMP=0x0000000100025dac
