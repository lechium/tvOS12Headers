...
+ (id)sirilandView;	// IMP=0x00000001000441dc
...
- (void)statusBarFrameDidChange;	// IMP=0x00000001000447d0
- (_Bool)_keylineIsVisible;	// IMP=0x0000000100044798
- (void)layoutSubviews;	// IMP=0x0000000100044468
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100044204
