...
- (void).cxx_destruct;	// IMP=0x000000010007edd8
- (void)_setCountdownString;	// IMP=0x000000010007ec20
- (void)_updateCountdown:(id)arg1;	// IMP=0x000000010007e9ac
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000010007e870
- (id)initWithAceObject:(id)arg1 conversationItemIdentifier:(id)arg2 interactionStyle:(long long)arg3;	// IMP=0x000000010007e71c
