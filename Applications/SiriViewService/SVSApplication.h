...
+ (id)sharedApplication;	// IMP=0x000000010007b878
@property(nonatomic) __weak id <SVSApplicationDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;	// IMP=0x000000010007b95c
- (void)setFrontMostAppOrientation:(long long)arg1;	// IMP=0x000000010007b918
- (long long)launchOrientation;	// IMP=0x000000010007b908
