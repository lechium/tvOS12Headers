...
+ (id)cancellationAnimationForTranscriptItem:(id)arg1;	// IMP=0x00000001000349e4
+ (id)confirmationAnimationForTranscriptItem:(id)arg1;	// IMP=0x0000000100034964
+ (id)animationForTranscriptItem:(id)arg1 updateType:(long long)arg2 replacedView:(id)arg3;	// IMP=0x00000001000348d4
+ (id)animationForTranscriptItem:(id)arg1 updateType:(long long)arg2;	// IMP=0x0000000100034864
...
- (void).cxx_destruct;	// IMP=0x0000000100035288
- (id)_animationTypeString;	// IMP=0x0000000100035030
- (id)description;	// IMP=0x0000000100034f60
- (double)pinMinimumDuration;	// IMP=0x0000000100034f24
- (double)animationDelay;	// IMP=0x0000000100034eb0
- (id)_snippetViewControllerIfExists;	// IMP=0x0000000100034e14
- (id)_aceViewControllerIfExists;	// IMP=0x0000000100034d78
- (id)initWithTranscriptItem:(id)arg1 replacedView:(id)arg2 updateType:(long long)arg3;	// IMP=0x0000000100034a64
