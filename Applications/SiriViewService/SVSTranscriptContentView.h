...
- (void).cxx_destruct;	// IMP=0x0000000100079a94
- (void)_setKeylineHidden:(id)arg1 hidden:(_Bool)arg2;	// IMP=0x0000000100079958
- (void)layoutSubviews;	// IMP=0x0000000100079600
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000795f0
- (id)initWithFrame:(struct CGRect)arg1 collectionView:(id)arg2;	// IMP=0x00000001000793c8
