...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x0000000100046478
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x00000001000463dc
- (void)incrementNumberOfStartedActions;	// IMP=0x00000001000463a4
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100046060
