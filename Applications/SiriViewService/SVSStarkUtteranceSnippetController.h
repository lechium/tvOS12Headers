...
- (void).cxx_destruct;	// IMP=0x000000010007f770
- (void)viewDidLoad;	// IMP=0x000000010007f6c4
- (void)loadView;	// IMP=0x000000010007f6ac
- (id)initWithAceObject:(id)arg1;	// IMP=0x000000010007f4d8
