...
+ (id)associatedDataStore;	// IMP=0x000000010008044c
...
- (void).cxx_destruct;	// IMP=0x000000010008092c
- (void)layoutSubviews;	// IMP=0x0000000100080620
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000804cc
- (void)_configureWithDisplayName:(id)arg1 contactPhoto:(id)arg2 contactPhotoURL:(id)arg3 contactIdentifier:(id)arg4 appImage:(id)arg5 nameComponents:(id)arg6;	// IMP=0x000000010007fc64
- (id)initWithMessageIntent:(id)arg1;	// IMP=0x000000010007fac4
- (id)initWithSms:(id)arg1;	// IMP=0x000000010007f99c
