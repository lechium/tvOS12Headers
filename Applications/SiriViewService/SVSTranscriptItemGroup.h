...
- (void).cxx_destruct;	// IMP=0x0000000100054204
- (void)removeElementAtIndex:(long long)arg1;	// IMP=0x00000001000540c8
- (void)shiftInsertionIndexesStartingAtIndex:(unsigned long long)arg1 by:(long long)arg2;	// IMP=0x00000001000540b0
- (void)replaceTranscriptItem:(id)arg1 withTranscriptItem:(id)arg2 cancelPresentationDelay:(_Bool)arg3;	// IMP=0x0000000100053f30
- (unsigned long long)insertionIndexForTranscriptItem:(id)arg1;	// IMP=0x0000000100053d60
- (void)_presentationEligibilityConditionDidChange;	// IMP=0x0000000100053b10
- (unsigned long long)countByEnumeratingWithState:(CDStruct_70511ce9 *)arg1 objects:(id *)arg2 count:(unsigned long long)arg3;	// IMP=0x0000000100053aa4
@property(readonly, nonatomic) NSIndexSet *insertionIndexes;
@property(readonly, nonatomic) NSArray *transcriptItems;
- (id)description;	// IMP=0x00000001000537e4
- (id)init;	// IMP=0x0000000100053760
- (id)initWithTranscriptItems:(id)arg1 insertionIndexes:(id)arg2 provisional:(_Bool)arg3 waitsForConfirmation:(_Bool)arg4 presentationDelay:(double)arg5;	// IMP=0x0000000100053458
