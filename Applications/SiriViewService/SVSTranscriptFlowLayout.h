...
- (void).cxx_destruct;	// IMP=0x00000001000790c8
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x0000000100078d8c
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)arg1;	// IMP=0x0000000100078c28
- (void)finalizeCollectionViewUpdates;	// IMP=0x0000000100078b58
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x000000010007894c
- (id)init;	// IMP=0x0000000100078840
