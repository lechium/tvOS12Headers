...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x0000000100019df4
- (void)_setImage:(id)arg1;	// IMP=0x0000000100019c80
- (id)_imageView;	// IMP=0x0000000100019ae8
- (void)_loadImage;	// IMP=0x00000001000193d4
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100019260
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100018e70
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000100018d64
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100018cbc
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000100018c48
- (void)setContentMode:(long long)arg1;	// IMP=0x0000000100018c24
- (void)layoutSubviews;	// IMP=0x0000000100018bb8
- (long long)contentMode;	// IMP=0x0000000100018ba0
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000100018b88
- (void)dealloc;	// IMP=0x0000000100018b1c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100018a30
