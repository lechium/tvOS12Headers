...
- (void)_clearCachedValues;	// IMP=0x0000000100050df8
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100050d28
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x0000000100050be8
- (_Bool)canBecomeFocused;	// IMP=0x0000000100050bdc
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x0000000100050b8c
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x0000000100050b3c
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x0000000100050aec
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x0000000100050a9c
- (void)setFont:(id)arg1;	// IMP=0x0000000100050a4c
- (void)setText:(id)arg1;	// IMP=0x00000001000509fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100050934
