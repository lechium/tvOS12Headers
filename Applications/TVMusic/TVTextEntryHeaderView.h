...
- (void).cxx_destruct;	// IMP=0x00000001000a2b70
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000a298c
- (struct CGRect)_messageViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x00000001000a2790
- (struct CGRect)_imageViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x00000001000a270c
- (struct CGRect)_titleViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x00000001000a2608
- (void)layoutSubviews;	// IMP=0x00000001000a251c
