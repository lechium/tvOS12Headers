...
+ (id)playlistViewFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00000001000a7d64
...
- (id)_randomColor;	// IMP=0x00000001000a9f44
- (void)_configureLabel:(id)arg1 withTextElement:(id)arg2 maxWidth:(double)arg3;	// IMP=0x00000001000a9db0
- (struct CGRect)_scaleRect:(struct CGRect)arg1 withStyle:(id)arg2;	// IMP=0x00000001000a9c94
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000a9aa4
- (void)layoutSubviews;	// IMP=0x00000001000a99c0
- (void)layoutWithElement:(id)arg1;	// IMP=0x00000001000a84e4
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000a8458
- (void)prepareForReuse;	// IMP=0x00000001000a8404
- (_Bool)canBecomeFocused;	// IMP=0x00000001000a83fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000a7e30
