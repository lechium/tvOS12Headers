...
- (id)preferredFocusEnvironments;	// IMP=0x00000001000116ec
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000115fc
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100011368
- (id)initWithPlayer:(id)arg1;	// IMP=0x00000001000112e0
