...
+ (struct CGSize)getAttributedTextSize:(id)arg1 font:(id)arg2 maxWidth:(double)arg3;	// IMP=0x0000000100075714
...
- (void).cxx_destruct;	// IMP=0x0000000100075968
- (void)configureUIControls;	// IMP=0x000000010007527c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100075060
- (void)_onSelectSignIn:(id)arg1;	// IMP=0x0000000100075000
- (void)layoutSubviews;	// IMP=0x0000000100074bfc
- (id)preferredFocusEnvironments;	// IMP=0x0000000100074a2c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000747c4
