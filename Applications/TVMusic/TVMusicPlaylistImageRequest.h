...
- (void).cxx_destruct;	// IMP=0x00000001000426f4
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100041e44
- (id)identifier;	// IMP=0x0000000100041868
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x0000000100041798
