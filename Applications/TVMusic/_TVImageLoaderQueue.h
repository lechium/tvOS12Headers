...
- (void).cxx_destruct;	// IMP=0x000000010007cfbc
- (void)_checkForPreloadCompletion;	// IMP=0x000000010007cdf0
- (void)_artworkDidFail:(id)arg1;	// IMP=0x000000010007ccd0
- (void)_artworkDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x000000010007cbe4
- (void)_loadPendingImages;	// IMP=0x000000010007c8d4
- (id)_artworkCatalogToLoadNext;	// IMP=0x000000010007c7f8
- (void)_fillQueue;	// IMP=0x000000010007c6c8
- (long long)_currentQueueSize;	// IMP=0x000000010007c654
- (id)popNextImage;	// IMP=0x000000010007c598
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010007c52c
- (id)init;	// IMP=0x000000010007c35c
